...
func (_IRuleEntitlement *IRuleEntitlementCaller) IsEntitled(opts *bind.CallOpts, channelId string, user []common.Address, permission [32]byte) (bool, error) {
	var out []interface{}
...
//
// Solidity: function isEntitled(string channelId, address[] user, bytes32 permission) view returns(bool)
func (_IRuleEntitlement *IRuleEntitlementSession) IsEntitled(channelId string, user []common.Address, permission [32]byte) (bool, error) {
...
//
// Solidity: function isEntitled(string channelId, address[] user, bytes32 permission) view returns(bool)
func (_IRuleEntitlement *IRuleEntitlementCallerSession) IsEntitled(channelId string, user []common.Address, permission [32]byte) (bool, error) {
	return _IRuleEntitlement.Contract.IsEntitled(&_IRuleEntitlement.CallOpts, channelId, user, permission)
}
