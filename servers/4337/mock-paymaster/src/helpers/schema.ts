...
export const userOperationSchemaPaymasterV6 = z
	.object({
...
export const userOperationSchemaPaymasterV7 = z
	.object({
		sender: addressSchema,
		nonce: hexNumberSchema,
...
export const alchemyGasRequestSchema = z.tuple([
	z.object({ 
		policyId: z.string(),
		entryPoint: z.string(),
		dummySignature: z.string(),
...
const eip7677UserOperationSchemaV6 = z
	.object({
		...
		// special alchemy handler override for gas overrides
		gasOverrides: z.object({
			maxFeePerGas: hexNumberSchema.optional(),
			maxPriorityFeePerGas: hexNumberSchema.optional(),
		}),
	})
	.strict()
	.transform((val) => {
