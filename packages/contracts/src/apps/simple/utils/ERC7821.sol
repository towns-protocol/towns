...
///
/// @dev Modified from the original Solady implementation:
/// - Removed `Receiver` inheritance (handled separately in implementing contracts)
/// - Updated Solidity version to ^0.8.29
///
...
contract ERC7821 is IERC7821 {
    ...
    function _get(
        Call[] calldata calls,
        uint256 i
    ) internal view virtual returns (address to, uint256 value, bytes calldata data) {
        /// @solidity memory-safe-assembly
        assembly {
