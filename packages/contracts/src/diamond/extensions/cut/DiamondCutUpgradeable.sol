...
abstract contract DiamondCutUpgradeable is IDiamondCutEvents {
  function __DiamondCutUpgradeable_init() internal {
    IntrospectionService.addInterface(type(IDiamondCut).interfaceId);
  }
