...
import {IDrop} from "src/utils/interfaces/IDrop.sol";
...
contract Drop is IDrop {
    ...
    function setClaimConditions(
        ...
        /// @dev If the claim conditions are being reset, we assign a new uid to the claim
        /// conditions.
        /// which ends up resetting the eligibility of the claim conditions in
