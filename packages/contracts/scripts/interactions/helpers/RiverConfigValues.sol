...
library RiverConfigValues {
    ...
    bytes32 public constant STREAM_HISTORY_MINIBLOCKS_USER_SETTINGS = keccak256("stream.historyminiblocks.a5");
    bytes32 public constant STREAM_TRIM_ACTIVATION_FACTOR = keccak256("stream.trimactivationfactor");
}
