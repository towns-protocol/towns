...
//contracts
import {ImplementationRegistryFacet} from "src/factory/facets/registry/ImplementationRegistryFacet.sol";
...
library DeployImplementationRegistry {
    ...
    function deploy() internal returns (address) {
        return LibDeploy.deployCode("ImplementationRegistryFacet.sol", "");
    }
}
