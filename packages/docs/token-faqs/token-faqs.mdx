...
$TOWNS was deployed with an initial supply of 10 billion tokens on Ethereum Mainnet. Additional tokens are minted starting after year 1 according to a predetermined inflation schedule and distributed bi-weekly to active Node Operators and their Delegators.
