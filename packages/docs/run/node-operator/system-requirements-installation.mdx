...
|DEBUGENDPOINTS__CACHE|Enable cache debug endpoints|No|false|-|
|DEBUGENDPOINTS__CORRUPTSTREAMS|Enable corrupt streams debug endpoints|No|false|-|
|DEBUGENDPOINTS__ENABLESTORAGEENDPOINT|Enable storage statistics endpoints|No|false|-|
|DEBUGENDPOINTS__MEMORY|Enable memory debug endpoints|No|false|-|
|DEBUGENDPOINTS__MEMPROFILEDIR|Directory for memory profile files|No|./mem_profile|-|
|DEBUGENDPOINTS__MEMPROFILEINTERVAL|Memory profile write interval|No|5m|-|
...
|DEBUGENDPOINTS__STACKS|Enable stack debug endpoints|No|false|-|
|DEBUGENDPOINTS__STACKSMAXSIZEKB|Maximum stack size in KB|No|1024|-|
|DEBUGENDPOINTS__STREAM|Enable stream debug endpoints|No|false|-|
|DEBUGENDPOINTS__TXPOOL|Enable transaction pool debug endpoints|No|false|-|
