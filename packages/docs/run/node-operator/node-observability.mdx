...
description: "This guide describes the observability capabilities of Towns Stream Nodes and how to monitor and manage them."
---
...
Here are the required environment variables for the **Towns Stream Node Container** related to telemetry:
