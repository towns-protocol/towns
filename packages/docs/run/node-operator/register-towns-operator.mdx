...
<Step title="DAO approves operator">DAO approves operator in Base and Towns Chain via governance once 100mm delegations of RVR token are received to the operator</Step>
