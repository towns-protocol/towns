...
Towns protocol follows a weekly release schedule for both testnet and mainnet environments. Stream node images are built and published to the [**Towns Docker ECR**](https://public.ecr.aws/h5v6m2x1/river), with announcements made in the **Towns Operator Telegram Group**.
