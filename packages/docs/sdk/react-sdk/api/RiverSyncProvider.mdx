...
```ts
import { RiverSyncProvider } from '@towns-protocol/react-sdk'
```
...
**Source:** [RiverSyncProvider](https://github.com/towns-protocol/towns/blob/main/packages/react-sdk/src/RiverSyncProvider.tsx)
