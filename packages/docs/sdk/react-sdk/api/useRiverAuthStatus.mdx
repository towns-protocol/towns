...
```ts
import { useRiverAuthStatus } from '@towns-protocol/react-sdk'
```
...
**Source:** [useRiverAuthStatus](https://github.com/towns-protocol/towns/blob/main/packages/react-sdk/src/useRiverAuthStatus.ts)
