...
Upon registering as a Node Operator and receiving sufficient delegation of TOWNS tokens by the DAO, nodes under the Node Operator will enter the active set and be eligible to host / server streams. 
...
Yes, the DAO will require a minimum of 100mm TOWNS tokens and maximum of 500mm TOWNS tokens to be delegated to a Node Operator before they can enter the Towns Network. 
