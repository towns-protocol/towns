...
|---------------------------|---------|----------|---------------|------|
|ARCHITECTCONTRACT__ADDRESS|SpaceFactory contract address in Base Network|Yes|0x5A077e686545c541476D3a99711dE42339357467|-|
...
|ENTITLEMENT_CONTRACT__ADDRESS|Entitlement contract address in Base Network|Yes|0x0d7eC5826626070b6a250C9878940D070128A265|-|
...
|REGISTRYCONTRACT__ADDRESS|River Registry contract address in Towns Chain Network|Yes|0x94bdc7016057fc47cC006Bc837bF0Aed5Dc5C6D6|-|
...
|TOWNS_ENV|Environment name for network configuration (beta for testnet, omega for mainnet)|Yes|beta|-|
