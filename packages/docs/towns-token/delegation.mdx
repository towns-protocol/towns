...
Towns tokens can be delegated by calling the `delegate()` function on the Base [Towns.sol](https://github.com/towns-protocol/towns/blob/main/packages/contracts/src/tokens/towns/base/Towns.sol) contract. An interface is provided at https://river.build/delegate.
