...
<Note>
Your bot wallet will need to be funded with Base ETH to pay for gas fee transactions.
...
<Note>
Your bot wallet will need to be funded with Base ETH to pay for gas fee banning transactions.
...
<Note>
Your bot wallet will need to be funded with Base ETH to pay for gas fee unbanning transactions.
You receive the wallet credentials after creating your bot.
</Note>
