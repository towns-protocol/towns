...
Interactive messages let your bot create buttons, text inputs, and forms for user interactions. These are UI elements that don't require blockchain transactions.
...
- Learn about [onchain integrations](/build/bots/onchain-integrations) for blockchain interactions
