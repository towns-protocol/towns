...
When creating your bot, provide the x402 facilitator configuration:
...
const bot = await makeTownsBot(
  ...
  process.env.JWT_SECRET!,
  {
    commands,
    paymentConfig: {
      // Testnet/public (x402.org):
      // url: 'https://www.x402.org/facilitator',
      //
      // CDP (Coinbase) hosted:
      // url: 'https://api.cdp.coinbase.com/platform/v2/x402',
      url: process.env.X402_FACILITATOR_URL!,
      apiKey: process.env.X402_API_KEY, // Optional (depends on facilitator)
    },
  }
)
```
