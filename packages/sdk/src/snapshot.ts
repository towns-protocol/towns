...
export type SnapshotUpdateFn = (snapshot: Snapshot) => void
...
export function updateSnapshot(
    ...
    const { event: parsedEvent, miniblockNum, eventNum } = confirmedEvent
    ...
    switch (event.payload.case) {
        ...
        case 'channelPayload':
            return updateSnapshotChannel(event.payload.value, miniblockNum, eventNum)

        case 'dmChannelPayload':
            return updateSnapshotDmChannel(event.payload.value, miniblockNum, eventNum)

        case 'gdmChannelPayload':
            return updateSnapshotGdmChannel(event.payload.value, eventHash, miniblockNum, eventNum)

        case 'userPayload':
            return updateSnapshotUser(event.payload.value, miniblockNum, eventNum)

        case 'userSettingsPayload':
            return updateSnapshotUserSettings(event.payload.value, miniblockNum, eventNum)

        case 'userMetadataPayload':
            return updateSnapshotUserMetadata(
                event.payload.value,
                eventHash,
                miniblockNum,
                eventNum,
        ...
        case 'userInboxPayload':
            return updateSnapshotUserInbox(event.payload.value, miniblockNum, eventNum)
