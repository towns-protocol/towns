...
/** @deprecated use unpacker.unpackStream instead */
export const unpackStream = unpacker.unpackStream

/** @deprecated use unpacker.unpackStreamEx instead */
export const unpackStreamEx = unpacker.unpackStreamEx

/** @deprecated use unpacker.unpackStreamAndCookie instead */
export const unpackStreamAndCookie = unpacker.unpackStreamAndCookie

/**
 * @deprecated use unpacker.unpackMiniblock instead
...
/** @deprecated use unpacker.unpackEnvelope instead */
export const unpackEnvelope = unpacker.unpackEnvelope

/** @deprecated use unpacker.unpackSnapshot instead */
export const unpackSnapshot = unpacker.unpackSnapshot

/** @deprecated use unpacker.unpackStreamEnvelopes instead */
