...
export interface PioneerFacetInterface extends utils.Interface {
  functions: {
    ...
    "__Pioneer_init(string,string,string,uint256,address)": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "getMintReward()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "__Pioneer_init",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "getMintReward",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PioneerFacet extends BaseContract {
  ...
  functions: {
    ...
    getMintReward(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    setMintReward(
      newMintReward: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  populateTransaction: {
    ...
    getMintReward(overrides?: CallOverrides): Promise<PopulatedTransaction>;
