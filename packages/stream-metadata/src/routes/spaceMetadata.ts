...
export const spaceMetadataBaseUrl =
    `${config.streamMetadataBaseUrl}/space`.toLowerCase()
...
export async function fetchSpaceMetadata(
    ...
    try {
        ...
        return reply
            ...
            .send({
                error: 'Not Found',
                message: 'Failed to fetch space contract info',
            })
    }
