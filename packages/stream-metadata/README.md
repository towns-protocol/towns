...
- **Original images**: Long-term immutable cache (`max-age=31536000, immutable`)
- **Resized images**: Daily client cache with long-term CDN cache (`max-age=86400, s-maxage=31536000`)
