// Selector for executeUserOp function (used by modular accounts)
// This is the first 4 bytes of keccak256("executeUserOp((address,uint256,bytes,bytes,bytes32,uint256,bytes32,bytes,bytes),bytes32)")
export const EXECUTE_USER_OP_SELECTOR = '0x8DD7712F' as const

// Modular account execute ABI (single call with value)
export const modularExecuteAbi = [
    {
        type: 'function',
        name: 'execute',
        inputs: [
...
// Modular account executeBatch ABI (tuple[] with target, value, data)
export const modularExecuteBatchAbi = [
    {
        type: 'function',
        name: 'executeBatch',
        inputs: [
