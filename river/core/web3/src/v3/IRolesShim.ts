...
} from '@river/generated/dev/typings/IRoles'
import {
    IRoles as BaseSepoliaContract,
    IRolesInterface as BaseSepoliaInterface,
} from '@river/generated/v3/typings/IRoles'

import LocalhostAbi from '@river/generated/dev/abis/Roles.abi.json' assert { type: 'json' }
import BaseSepoliaAbi from '@river/generated/v3/abis/Roles.abi.json' assert { type: 'json' }
