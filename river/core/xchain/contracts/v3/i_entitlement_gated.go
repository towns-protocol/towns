...
//
// Solidity: function requestEntitlementCheck(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) ) returns(bytes32)
func (_IEntitlementGated *IEntitlementGatedTransactor) RequestEntitlementCheck(opts *bind.TransactOpts, arg0 IRuleEntitlementRuleData) (*types.Transaction, error) {
	return _IEntitlementGated.contract.Transact(opts, "requestEntitlementCheck", arg0)
}

// RequestEntitlementCheck is a paid mutator transaction binding the contract method 0xefa8db23.
//
// Solidity: function requestEntitlementCheck(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) ) returns(bytes32)
func (_IEntitlementGated *IEntitlementGatedSession) RequestEntitlementCheck(arg0 IRuleEntitlementRuleData) (*types.Transaction, error) {
	return _IEntitlementGated.Contract.RequestEntitlementCheck(&_IEntitlementGated.TransactOpts, arg0)
}

// RequestEntitlementCheck is a paid mutator transaction binding the contract method 0xefa8db23.
//
// Solidity: function requestEntitlementCheck(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) ) returns(bytes32)
func (_IEntitlementGated *IEntitlementGatedTransactorSession) RequestEntitlementCheck(arg0 IRuleEntitlementRuleData) (*types.Transaction, error) {
	return _IEntitlementGated.Contract.RequestEntitlementCheck(&_IEntitlementGated.TransactOpts, arg0)
}
