...
func (_IEntitlementGated *IEntitlementGatedTransactor) RequestEntitlementCheck(opts *bind.TransactOpts, ruleData IRuleEntitlementRuleData) (*types.Transaction, error) {
	return _IEntitlementGated.contract.Transact(opts, "requestEntitlementCheck", ruleData)
}

// RequestEntitlementCheck is a paid mutator transaction binding the contract method 0xefa8db23.
//
// Solidity: function requestEntitlementCheck(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) ruleData) returns(bytes32)
func (_IEntitlementGated *IEntitlementGatedSession) RequestEntitlementCheck(ruleData IRuleEntitlementRuleData) (*types.Transaction, error) {
	return _IEntitlementGated.Contract.RequestEntitlementCheck(&_IEntitlementGated.TransactOpts, ruleData)
}

// RequestEntitlementCheck is a paid mutator transaction binding the contract method 0xefa8db23.
//
// Solidity: function requestEntitlementCheck(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) ruleData) returns(bytes32)
func (_IEntitlementGated *IEntitlementGatedTransactorSession) RequestEntitlementCheck(ruleData IRuleEntitlementRuleData) (*types.Transaction, error) {
	return _IEntitlementGated.Contract.RequestEntitlementCheck(&_IEntitlementGated.TransactOpts, ruleData)
}
