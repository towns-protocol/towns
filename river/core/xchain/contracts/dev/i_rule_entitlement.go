...
func (_IRuleEntitlement *IRuleEntitlementCaller) EncodeRuleData(opts *bind.CallOpts, data IRuleEntitlementRuleData) ([]byte, error) {
	var out []interface{}
	err := _IRuleEntitlement.contract.Call(opts, &out, "encodeRuleData", data)
...
//
// Solidity: function encodeRuleData(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) data) pure returns(bytes)
func (_IRuleEntitlement *IRuleEntitlementSession) EncodeRuleData(data IRuleEntitlementRuleData) ([]byte, error) {
	return _IRuleEntitlement.Contract.EncodeRuleData(&_IRuleEntitlement.CallOpts, data)
}

// EncodeRuleData is a free data retrieval call binding the contract method 0x5d115072.
//
// Solidity: function encodeRuleData(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) data) pure returns(bytes)
func (_IRuleEntitlement *IRuleEntitlementCallerSession) EncodeRuleData(data IRuleEntitlementRuleData) ([]byte, error) {
	return _IRuleEntitlement.Contract.EncodeRuleData(&_IRuleEntitlement.CallOpts, data)
}
