...
import LocalhostAbi from '@river/generated/dev/abis/Multicall.abi.json' assert { type: 'json' }
import BaseSepoliaAbi from '@river/generated/v3/abis/Multicall.abi.json' assert { type: 'json' }
