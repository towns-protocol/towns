...
// JoinSpace is a paid mutator transaction binding the contract method 0x280a47c7.
//
// Solidity: function joinSpace(uint8 action, bytes data) payable returns()
func (_Membership *MembershipTransactor) JoinSpace(opts *bind.TransactOpts, action uint8, data []byte) (*types.Transaction, error) {
	return _Membership.contract.Transact(opts, "joinSpace", action, data)
}

// JoinSpace is a paid mutator transaction binding the contract method 0x280a47c7.
//
// Solidity: function joinSpace(uint8 action, bytes data) payable returns()
func (_Membership *MembershipSession) JoinSpace(action uint8, data []byte) (*types.Transaction, error) {
	return _Membership.Contract.JoinSpace(&_Membership.TransactOpts, action, data)
}

// JoinSpace is a paid mutator transaction binding the contract method 0x280a47c7.
//
// Solidity: function joinSpace(uint8 action, bytes data) payable returns()
func (_Membership *MembershipTransactorSession) JoinSpace(action uint8, data []byte) (*types.Transaction, error) {
	return _Membership.Contract.JoinSpace(&_Membership.TransactOpts, action, data)
}

// JoinSpace0 is a paid mutator transaction binding the contract method 0x8c625b06.
//
// Solidity: function joinSpace(address receiver) payable returns()
func (_Membership *MembershipTransactor) JoinSpace0(opts *bind.TransactOpts, receiver common.Address) (*types.Transaction, error) {
	return _Membership.contract.Transact(opts, "joinSpace0", receiver)
}

// JoinSpace0 is a paid mutator transaction binding the contract method 0x8c625b06.
//
// Solidity: function joinSpace(address receiver) payable returns()
func (_Membership *MembershipSession) JoinSpace0(receiver common.Address) (*types.Transaction, error) {
	return _Membership.Contract.JoinSpace0(&_Membership.TransactOpts, receiver)
}

// JoinSpace0 is a paid mutator transaction binding the contract method 0x8c625b06.
//
// Solidity: function joinSpace(address receiver) payable returns()
func (_Membership *MembershipTransactorSession) JoinSpace0(receiver common.Address) (*types.Transaction, error) {
	return _Membership.Contract.JoinSpace0(&_Membership.TransactOpts, receiver)
}
