...
func (_StreamRegistryV1 *StreamRegistryV1Transactor) UpdateStreams(opts *bind.TransactOpts, requests []UpdateStream) (*types.Transaction, error) {
	return _StreamRegistryV1.contract.Transact(opts, "updateStreams", requests)
}

// UpdateStreams is a paid mutator transaction binding the contract method 0x33b86ab2.
//
// Solidity: function updateStreams((bytes32,address[],uint8,bytes32)[] requests) returns()
func (_StreamRegistryV1 *StreamRegistryV1Session) UpdateStreams(requests []UpdateStream) (*types.Transaction, error) {
	return _StreamRegistryV1.Contract.UpdateStreams(&_StreamRegistryV1.TransactOpts, requests)
}

// UpdateStreams is a paid mutator transaction binding the contract method 0x33b86ab2.
//
// Solidity: function updateStreams((bytes32,address[],uint8,bytes32)[] requests) returns()
func (_StreamRegistryV1 *StreamRegistryV1TransactorSession) UpdateStreams(requests []UpdateStream) (*types.Transaction, error) {
	return _StreamRegistryV1.Contract.UpdateStreams(&_StreamRegistryV1.TransactOpts, requests)
}
