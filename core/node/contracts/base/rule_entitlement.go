...
func (_RuleEntitlement *RuleEntitlementCaller) IsEntitled(opts *bind.CallOpts, channelId string, user []common.Address, permission [32]byte) (bool, error) {
	var out []interface{}
...
//
// Solidity: function isEntitled(string channelId, address[] user, bytes32 permission) view returns(bool)
func (_RuleEntitlement *RuleEntitlementSession) IsEntitled(channelId string, user []common.Address, permission [32]byte) (bool, error) {
...
//
// Solidity: function isEntitled(string channelId, address[] user, bytes32 permission) view returns(bool)
func (_RuleEntitlement *RuleEntitlementCallerSession) IsEntitled(channelId string, user []common.Address, permission [32]byte) (bool, error) {
	return _RuleEntitlement.Contract.IsEntitled(&_RuleEntitlement.CallOpts, channelId, user, permission)
}
...
func (_RuleEntitlement *RuleEntitlementCaller) SetRuleData(opts *bind.CallOpts, data IRuleEntitlementRuleData) ([]byte, error) {
	var out []interface{}
	err := _RuleEntitlement.contract.Call(opts, &out, "setRuleData", data)
...
//
// Solidity: function setRuleData(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) data) pure returns(bytes)
func (_RuleEntitlement *RuleEntitlementSession) SetRuleData(data IRuleEntitlementRuleData) ([]byte, error) {
	return _RuleEntitlement.Contract.SetRuleData(&_RuleEntitlement.CallOpts, data)
}

// SetRuleData is a free data retrieval call binding the contract method 0xa42bffc9.
//
// Solidity: function setRuleData(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) data) pure returns(bytes)
func (_RuleEntitlement *RuleEntitlementCallerSession) SetRuleData(data IRuleEntitlementRuleData) ([]byte, error) {
	return _RuleEntitlement.Contract.SetRuleData(&_RuleEntitlement.CallOpts, data)
}
