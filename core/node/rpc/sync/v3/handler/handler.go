...
import (
	...
	"github.com/towns-protocol/towns/core/node/rpc/sync/v3/eventbus"
...
type (
	...
	SyncStreamHandler interface {
		...
		//
		// TODO: discuss what error needs to be returned for streams that can't be found.
...
func (s *syncStreamHandlerImpl) Cancel() {
	//TODO implement me
	panic("implement me")
}
...
func (s *syncStreamHandlerRegistryImpl) New() SyncStreamHandler {
