...
export enum StreamKind {
  ...
  /**
   * @generated from enum value: SK_USER_SETTING = 4;
   */
  SK_USER_SETTING = 4,
}
...
/**
 * @generated from enum casablanca.UserSettingOp
 */
export enum UserSettingOp {
  /**
   * @generated from enum value: USO_UNSPECIFIED = 0;
   */
  USO_UNSPECIFIED = 0,

  /**
   * @generated from enum value: USO_FULLY_READ = 1;
   */
  USO_FULLY_READ = 1,
}
// Retrieve enum metadata with: proto3.getEnumType(UserSettingOp)
proto3.util.setEnumType(UserSettingOp, "casablanca.UserSettingOp", [
  { no: 0, name: "USO_UNSPECIFIED" },
  { no: 1, name: "USO_FULLY_READ" },
]);
...
export class Payload extends Message<Payload> {
  ...
  payload: {
    ...
    /**
     * @generated from field: casablanca.Payload.UserSetting user_setting = 6;
     */
    value: Payload_UserSetting;
    case: "userSetting";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "user_setting", kind: "message", T: Payload_UserSetting, oneof: "payload" },
  ]);
...
/**
 * @generated from message casablanca.Payload.UserSetting
 */
export class Payload_UserSetting extends Message<Payload_UserSetting> {
  /**
   * @generated from field: casablanca.UserSettingOp op = 1;
   */
  op = UserSettingOp.USO_UNSPECIFIED;
  ...
  /**
   * @generated from field: optional casablanca.EventRef origin_event = 4;
   */
  originEvent?: EventRef;

  constructor(data?: PartialMessage<Payload_UserSetting>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "casablanca.Payload.UserSetting";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "op", kind: "enum", T: proto3.getEnumType(UserSettingOp) },
    { no: 2, name: "value", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
    { no: 3, name: "channel_id", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 4, name: "origin_event", kind: "message", T: EventRef, opt: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Payload_UserSetting {
    return new Payload_UserSetting().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Payload_UserSetting {
    return new Payload_UserSetting().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Payload_UserSetting {
    return new Payload_UserSetting().fromJsonString(jsonString, options);
  }

  static equals(a: Payload_UserSetting | PlainMessage<Payload_UserSetting> | undefined, b: Payload_UserSetting | PlainMessage<Payload_UserSetting> | undefined): boolean {
    return proto3.util.equals(Payload_UserSetting, a, b);
  }
}
