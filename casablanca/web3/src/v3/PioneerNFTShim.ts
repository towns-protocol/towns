...
import GoerliAbi from '@towns/generated/goerli/v3/abis/PioneerFacet.abi.json' assert { type: 'json' }
import LocalhostAbi from '@towns/generated/localhost/v3/abis/PioneerFacet.abi.json' assert { type: 'json' }
import SepoliaAbi from '@towns/generated/sepolia/v3/abis/PioneerFacet.abi.json' assert { type: 'json' }
