...
// @ts-ignore
export class SpaceDappV4<T extends Transport, C extends Chain> implements ISpaceDapp<T, C> {
    private readonly chainId: C['id']
    private readonly client: PublicClient<T, C> | undefined
    private readonly townRegistrar: TownRegistrar<T, C>

    constructor(chainId: C['id'], client: PublicClient<T, C> | undefined) {
