...
import { MockERC721AShim, getContractsInfoV3 } from '../src'
...
class LocalhostWeb3Provider extends ethers.providers.JsonRpcProvider {
    ...
    constructor(wallet?: ethers.Wallet) {
        const networkUrl = process.env.ETHERS_NETWORK ?? 'http://127.0.0.1:8545' // OR "rinkeby"
        super(networkUrl)
