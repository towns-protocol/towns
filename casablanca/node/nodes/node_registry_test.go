...
func TestFromString(t *testing.T) {
	str := `0xda111744c29bF450d6D20BD10d383d17Fe8A8D70,http://localhost:8080,0x363BD2327d249f178333A2CCC8bA6ccB715DBEb2,http://localhost:8081,793bfbc421C71F19577F789A3398275f1b0125Ee,http://localhost:8082`

	registry, err := NewNodeRegistryFromString(context.Background(), str, "0x793bFbc421C71F19577F789A3398275f1b0125Ee")
