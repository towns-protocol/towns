...
type UsernameOp int32

const (
	UsernameOp_UNO_UNSPECIFIED               UsernameOp = 0
	UsernameOp_UNO_EDIT_USERNAME             UsernameOp = 1
	UsernameOp_UNO_EDIT_DISPLAYNAME          UsernameOp = 2
	UsernameOp_UNO_EDIT_USERNAME_DISPLAYNAME UsernameOp = 3
)

// Enum value maps for UsernameOp.
var (
	UsernameOp_name = map[int32]string{
		0: "UNO_UNSPECIFIED",
		1: "UNO_EDIT_USERNAME",
		2: "UNO_EDIT_DISPLAYNAME",
		3: "UNO_EDIT_USERNAME_DISPLAYNAME",
	}
	UsernameOp_value = map[string]int32{
		"UNO_UNSPECIFIED":               0,
		"UNO_EDIT_USERNAME":             1,
		"UNO_EDIT_DISPLAYNAME":          2,
		"UNO_EDIT_USERNAME_DISPLAYNAME": 3,
	}
)

func (x UsernameOp) Enum() *UsernameOp {
	p := new(UsernameOp)
	*p = x
	return p
}

func (x UsernameOp) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (UsernameOp) Descriptor() protoreflect.EnumDescriptor {
	return file_protocol_proto_enumTypes[0].Descriptor()
}

func (UsernameOp) Type() protoreflect.EnumType {
	return &file_protocol_proto_enumTypes[0]
}

func (x UsernameOp) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use UsernameOp.Descriptor instead.
func (UsernameOp) EnumDescriptor() ([]byte, []int) {
...
func (x *SpacePayload) GetUsername() *SpacePayload_Username {
	if x, ok := x.GetContent().(*SpacePayload_Username_); ok {
		return x.Username
	}
	return nil
}
...
type SpacePayload_Username_ struct {
	Username *SpacePayload_Username `protobuf:"bytes,4,opt,name=username,proto3,oneof"`
}
...
func (*SpacePayload_Username_) isSpacePayload_Content() {}
...
func (x *LinkWalletRequest) GetNonce() uint64 {
	if x != nil {
		return x.Nonce
	}
	return 0
...
type GetLinkWalletNonceRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetLinkWalletNonceRequest) Reset() {
	*x = GetLinkWalletNonceRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetLinkWalletNonceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLinkWalletNonceRequest) ProtoMessage() {}

func (x *GetLinkWalletNonceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_proto_msgTypes[38]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLinkWalletNonceRequest.ProtoReflect.Descriptor instead.
func (*GetLinkWalletNonceRequest) Descriptor() ([]byte, []int) {
	return file_protocol_proto_rawDescGZIP(), []int{38}
}

func (x *GetLinkWalletNonceRequest) GetRootKeyId() string {
	if x != nil {
		return x.RootKeyId
	}
	return ""
...
type GetLinkWalletNonceResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetLinkWalletNonceResponse) Reset() {
	*x = GetLinkWalletNonceResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetLinkWalletNonceResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLinkWalletNonceResponse) ProtoMessage() {}

func (x *GetLinkWalletNonceResponse) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_proto_msgTypes[39]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLinkWalletNonceResponse.ProtoReflect.Descriptor instead.
func (*GetLinkWalletNonceResponse) Descriptor() ([]byte, []int) {
	return file_protocol_proto_rawDescGZIP(), []int{39}
}

func (x *GetLinkWalletNonceResponse) GetNonce() uint64 {
	if x != nil {
		return x.Nonce
	}
	return 0
...
type SpacePayload_Snapshot struct {
	...
	// userId: Username
	Usernames map[string]*SpacePayload_Username `protobuf:"bytes,4,rep,name=usernames,proto3" json:"usernames,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// userId: Displayname
	Displaynames map[string]*SpacePayload_Username `protobuf:"bytes,5,rep,name=displaynames,proto3" json:"displaynames,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *SpacePayload_Snapshot) GetUsernames() map[string]*SpacePayload_Username {
	if x != nil {
		return x.Usernames
	}
	return nil
...
func (x *SpacePayload_Snapshot) GetDisplaynames() map[string]*SpacePayload_Username {
	if x != nil {
...
type SpacePayload_Username struct {
	...
	Op                 UsernameOp     `protobuf:"varint,1,opt,name=op,proto3,enum=casablanca.UsernameOp" json:"op,omitempty"`
	UserId             string         `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	UsernameProperties *EncryptedData `protobuf:"bytes,3,opt,name=username_properties,json=usernameProperties,proto3" json:"username_properties,omitempty"`
	// reserved for a stable slot number ordering where the username was added to snapshot
	SlotNum *int64 `protobuf:"varint,4,opt,name=slot_num,json=slotNum,proto3,oneof" json:"slot_num,omitempty"`
}

func (x *SpacePayload_Username) Reset() {
	*x = SpacePayload_Username{}
	if protoimpl.UnsafeEnabled {
...
func (x *SpacePayload_Username) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpacePayload_Username) ProtoMessage() {}

func (x *SpacePayload_Username) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_proto_msgTypes[43]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpacePayload_Username.ProtoReflect.Descriptor instead.
func (*SpacePayload_Username) Descriptor() ([]byte, []int) {
	return file_protocol_proto_rawDescGZIP(), []int{4, 3}
}

func (x *SpacePayload_Username) GetOp() UsernameOp {
	if x != nil {
		return x.Op
	}
	return UsernameOp_UNO_UNSPECIFIED
}

func (x *SpacePayload_Username) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *SpacePayload_Username) GetUsernameProperties() *EncryptedData {
	if x != nil {
		return x.UsernameProperties
	}
	return nil
}

func (x *SpacePayload_Username) GetSlotNum() int64 {
...
var file_protocol_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0xc9, 0x05, 0x0a, 0x0b, 0x53, 0x74, 0x72, 0x65,
	...
	0x61, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c,
	0x6f, 0x61, 0x64, 0x22, 0xea, 0x02, 0x0a, 0x0f, 0x4d, 0x69, 0x6e, 0x69, 0x62, 0x6c, 0x6f, 0x63,
	...
	0x65, 0x6e, 0x74, 0x48, 0x61, 0x73, 0x68, 0x65, 0x73, 0x12, 0x35, 0x0a, 0x08, 0x73, 0x6e, 0x61,
	0x70, 0x73, 0x68, 0x6f, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x63, 0x61,
	0x73, 0x61, 0x62, 0x6c, 0x61, 0x6e, 0x63, 0x61, 0x2e, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f,
	0x74, 0x48, 0x01, 0x52, 0x08, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x88, 0x01, 0x01,
	0x12, 0x28, 0x0a, 0x10, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x6e, 0x75, 0x6d, 0x5f, 0x6f, 0x66,
	0x66, 0x73, 0x65, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x65, 0x76, 0x65, 0x6e,
	0x74, 0x4e, 0x75, 0x6d, 0x4f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x12, 0x2c, 0x0a, 0x04, 0x6e, 0x6f,
	...
	0x22, 0xab, 0x0c, 0x0a, 0x0c, 0x53, 0x70, 0x61, 0x63, 0x65, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61,
	...
	0x00, 0x52, 0x0a, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x12, 0x3f, 0x0a,
	...
	0x63, 0x65, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x55, 0x73, 0x65, 0x72, 0
 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	...
	0x64, 0x65, 0x62, 0x75, 0x67, 0x22, 0x2a, 0x0a, 0x0c, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73,
	...
	,
	...
	0x65, 0x73, 0x73, 0x65, 0x73, 0x22, 0x3b, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x6e, 0x6b,
	0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x4e, 0x6f, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	,
	...
	,
	...
	0x17, 0x12, 0x13, 0x0a, 0x0f, 0x42, 0x41, 0x44, 0x5f, 0x50, 0x52, 0x45, 0x56, 0x5f, 0x45, 0x56,
	0x45, 0x4e, 0x54, 0x53, 0x10, 0x18, 0x12, 0x16, 0x0a, 0x12, 0x4e, 0x4f, 0x5f, 0x45, 0x56, 0x45,
	...
	0x5f, 0x41, 0x44, 0x44, 0x52, 0x45, 0x53, 0x53, 0x10, 0x31, 0x32, 0xe7, 0x05, 0x0a, 0x0d, 0x53,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x51, 0x0a, 0x0c,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x1f, 0x2e, 0x63,
	...
	,
...
var file_protocol_proto_msgTypes = make([]protoimpl.MessageInfo, 73)
var file_protocol_proto_goTypes = []interface{}{
	(UsernameOp)(0),                              // 0: casablanca.UsernameOp
	(MembershipOp)(0),                            // 1: casablanca.MembershipOp
	(ChannelOp)(0),                               // 2: casablanca.ChannelOp
	(ToDeviceOp)(0),                              // 3: casablanca.ToDeviceOp
	(RiverKeyOp)(0),                              // 4: casablanca.RiverKeyOp
	(Err)(0),                                     // 5: casablanca.Err
	(*Miniblock)(nil),                            // 6: casablanca.Miniblock
	(*Envelope)(nil),                             // 7: casablanca.Envelope
	(*StreamEvent)(nil),                          // 8: casablanca.StreamEvent
	(*MiniblockHeader)(nil),                      // 9: casablanca.MiniblockHeader
	...
	(*UserSettingsPayload)(nil),                  // 13: casablanca.UserSettingsPayload
	(*UserDeviceKeyPayload)(nil),                 // 14: casablanca.UserDeviceKeyPayload
	(*MediaPayload)(nil),                         // 15: casablanca.MediaPayload
	(*Snapshot)(nil),                             // 16: casablanca.Snapshot
	(*EventRef)(nil),                             // 17: casablanca.EventRef
	(*StreamSettings)(nil),                       // 18: casablanca.StreamSettings
	(*Membership)(nil),                           // 19: casablanca.Membership
	(*EncryptedData)(nil),                        // 20: casablanca.EncryptedData
	(*EncryptedDeviceData)(nil),                  // 21: casablanca.EncryptedDeviceData
	(*EncryptedMessageEnvelope)(nil),             // 22: casablanca.EncryptedMessageEnvelope
	(*DeviceKeys)(nil),                           // 23: casablanca.DeviceKeys
	(*FallbackKeys)(nil),                         // 24: casablanca.FallbackKeys
	(*Key)(nil),                                  // 25: casablanca.Key
	(*SyncCookie)(nil),                           // 26: casablanca.SyncCookie
	(*StreamAndCookie)(nil),                      // 27: casablanca.StreamAndCookie
	(*CreateStreamRequest)(nil),                  // 28: casablanca.CreateStreamRequest
	(*CreateStreamResponse)(nil),                 // 29: casablanca.CreateStreamResponse
	(*GetStreamRequest)(nil),                     // 30: casablanca.GetStreamRequest
	(*GetStreamResponse)(nil),                    // 31: casablanca.GetStreamResponse
	(*GetMiniblocksRequest)(nil),                 // 32: casablanca.GetMiniblocksRequest
	(*GetMiniblocksResponse)(nil),                // 33: casablanca.GetMiniblocksResponse
	(*AddEventRequest)(nil),                      // 34: casablanca.AddEventRequest
	(*AddEventResponse)(nil),                     // 35: casablanca.AddEventResponse
	(*SyncStreamsRequest)(nil),                   // 36: casablanca.SyncStreamsRequest
	(*SyncStreamsResponse)(nil),                  // 37: casablanca.SyncStreamsResponse
	(*InfoRequest)(nil),                          // 38: casablanca.InfoRequest
	(*InfoResponse)(nil),                         // 39: casablanca.InfoResponse
	(*LinkWalletRequest)(nil),                    // 40: casablanca.LinkWalletRequest
	(*LinkWalletResponse)(nil),                   // 41: casablanca.LinkWalletResponse
	(*GetLinkedWalletsRequest)(nil),              // 42: casablanca.GetLinkedWalletsRequest
	(*GetLinkedWalletsResponse)(nil),             // 43: casablanca.GetLinkedWalletsResponse
	(*GetLinkWalletNonceRequest)(nil),            // 44: casablanca.GetLinkWalletNonceRequest
	(*GetLinkWalletNonceResponse)(nil),           // 45: casablanca.GetLinkWalletNonceResponse
	...
	(*SpacePayload_Username)(nil),                // 49: casablanca.SpacePayload.Username
	...
	(*ChannelPayload_Receipt)(nil),               // 56: casablanca.ChannelPayload.Receipt
	nil,                                          // 57: casablanca.ChannelPayload.Snapshot.MembershipsEntry
	(*UserPayload_Snapshot)(nil),                 // 58: casablanca.UserPayload.Snapshot
	(*UserPayload_Inception)(nil),                // 59: casablanca.UserPayload.Inception
	(*UserPayload_UserMembership)(nil),           // 60: casablanca.UserPayload.UserMembership
	(*UserPayload_ToDevice)(nil),                 // 61: casablanca.UserPayload.ToDevice
	nil,                                          // 62: casablanca.UserPayload.Snapshot.MembershipsEntry
	(*UserSettingsPayload_Snapshot)(nil),         // 63: casablanca.UserSettingsPayload.Snapshot
	(*UserSettingsPayload_Inception)(nil),        // 64: casablanca.UserSettingsPayload.Inception
	(*UserSettingsPayload_FullyReadMarkers)(nil), // 65: casablanca.UserSettingsPayload.FullyReadMarkers
	nil,                                    // 66: casablanca.UserSettingsPayload.Snapshot.FullyReadMarkersEntry
	(*UserDeviceKeyPayload_Snapshot)(nil),  // 67: casablanca.UserDeviceKeyPayload.Snapshot
	(*UserDeviceKeyPayload_Inception)(nil), // 68: casablanca.UserDeviceKeyPayload.Inception
	(*UserDeviceKeyPayload_UserDeviceKey)(nil), // 69: casablanca.UserDeviceKeyPayload.UserDeviceKey
	nil,                            // 70: casablanca.UserDeviceKeyPayload.Snapshot.UserDeviceKeysEntry
	(*MediaPayload_Snapshot)(nil),  // 71: casablanca.MediaPayload.Snapshot
	(*MediaPayload_Inception)(nil), // 72: casablanca.MediaPayload.Inception
	(*MediaPayload_Chunk)(nil),     // 73: casablanca.MediaPayload.Chunk
	nil,                            // 74: casablanca.EncryptedDeviceData.CiphertextEntry
	nil,                            // 75: casablanca.DeviceKeys.KeysEntry
	nil,                            // 76: casablanca.DeviceKeys.SignaturesEntry
	nil,                            // 77: casablanca.FallbackKeys.AlgoKeyIdEntry
	nil,                            // 78: casablanca.Key.SignaturesEntry
	(*timestamppb.Timestamp)(nil),  // 79: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),          // 80: google.protobuf.Empty
}
var file_protocol_proto_depIdxs = []int32{
	7,   // 0: casablanca.Miniblock.events:type_name -> casablanca.Envelope
	7,   // 1: casablanca.Miniblock.header:type_name -> casablanca.Envelope
	9,   // 2: casablanca.StreamEvent.miniblock_header:type_name -> casablanca.MiniblockHeader
	10,  // 3: casablanca.StreamEvent.space_payload:type_name -> casablanca.SpacePayload
	11,  // 4: casablanca.StreamEvent.channel_payload:type_name -> casablanca.ChannelPayload
	12,  // 5: casablanca.StreamEvent.user_payload:type_name -> casablanca.UserPayload
	13,  // 6: casablanca.StreamEvent.user_settings_payload:type_name -> casablanca.UserSettingsPayload
	14,  // 7: casablanca.StreamEvent.user_device_key_payload:type_name -> casablanca.UserDeviceKeyPayload
	15,  // 8: casablanca.StreamEvent.media_payload:type_name -> casablanca.MediaPayload
	79,  // 9: casablanca.MiniblockHeader.timestamp:type_name -> google.protobuf.Timestamp
	16,  // 10: casablanca.MiniblockHeader.snapshot:type_name -> casablanca.Snapshot
	80,  // 11: casablanca.MiniblockHeader.none:type_name -> google.protobuf.Empty
	47,  // 12: casablanca.SpacePayload.inception:type_name -> casablanca.SpacePayload.Inception
	48,  // 13: casablanca.SpacePayload.channel:type_name -> casablanca.SpacePayload.Channel
	19,  // 14: casablanca.SpacePayload.membership:type_name -> casablanca.Membership
	49,  // 15: casablanca.SpacePayload.username:type_name -> casablanca.SpacePayload.Username
	55,  // 16: casablanca.ChannelPayload.inception:type_name -> casablanca.ChannelPayload.Inception
	20,  // 17: casablanca.ChannelPayload.message:type_name -> casablanca.EncryptedData
	19,  // 18: casablanca.ChannelPayload.membership:type_name -> casablanca.Membership
	56,  // 19: casablanca.ChannelPayload.receipt:type_name -> casablanca.ChannelPayload.Receipt
	59,  // 20: casablanca.UserPayload.inception:type_name -> casablanca.UserPayload.Inception
	60,  // 21: casablanca.UserPayload.user_membership:type_name -> casablanca.UserPayload.UserMembership
	61,  // 22: casablanca.UserPayload.to_device:type_name -> casablanca.UserPayload.ToDevice
	64,  // 23: casablanca.UserSettingsPayload.inception:type_name -> casablanca.UserSettingsPayload.Inception
	65,  // 24: casablanca.UserSettingsPayload.fully_read_markers:type_name -> casablanca.UserSettingsPayload.FullyReadMarkers
	68,  // 25: casablanca.UserDeviceKeyPayload.inception:type_name -> casablanca.UserDeviceKeyPayload.Inception
	69,  // 26: casablanca.UserDeviceKeyPayload.user_device_key:type_name -> casablanca.UserDeviceKeyPayload.UserDeviceKey
	72,  // 27: casablanca.MediaPayload.inception:type_name -> casablanca.MediaPayload.Inception
	73,  // 28: casablanca.MediaPayload.chunk:type_name -> casablanca.MediaPayload.Chunk
	46,  // 29: casablanca.Snapshot.space_content:type_name -> casablanca.SpacePayload.Snapshot
	54,  // 30: casablanca.Snapshot.channel_content:type_name -> casablanca.ChannelPayload.Snapshot
	58,  // 31: casablanca.Snapshot.user_content:type_name -> casablanca.UserPayload.Snapshot
	63,  // 32: casablanca.Snapshot.user_settings_content:type_name -> casablanca.UserSettingsPayload.Snapshot
	67,  // 33: casablanca.Snapshot.user_device_key_content:type_name -> casablanca.UserDeviceKeyPayload.Snapshot
	71,  // 34: casablanca.Snapshot.media_content:type_name -> casablanca.MediaPayload.Snapshot
	1,   // 35: casablanca.Membership.op:type_name -> casablanca.MembershipOp
	74,  // 36: casablanca.EncryptedDeviceData.ciphertext:type_name -> casablanca.EncryptedDeviceData.CiphertextEntry
	75,  // 37: casablanca.DeviceKeys.keys:type_name -> casablanca.DeviceKeys.KeysEntry
	76,  // 38: casablanca.DeviceKeys.signatures:type_name -> casablanca.DeviceKeys.SignaturesEntry
	77,  // 39: casablanca.FallbackKeys.algo_key_id:type_name -> casablanca.FallbackKeys.AlgoKeyIdEntry
	78,  // 40: casablanca.Key.signatures:type_name -> casablanca.Key.SignaturesEntry
	7,   // 41: casablanca.StreamAndCookie.events:type_name -> casablanca.Envelope
	26,  // 42: casablanca.StreamAndCookie.next_sync_cookie:type_name -> casablanca.SyncCookie
	26,  // 43: casablanca.StreamAndCookie.original_sync_cookie:type_name -> casablanca.SyncCookie
	7,   // 44: casablanca.CreateStreamRequest.events:type_name -> casablanca.Envelope
	27,  // 45: casablanca.CreateStreamResponse.stream:type_name -> casablanca.StreamAndCookie
	6,   // 46: casablanca.CreateStreamResponse.miniblocks:type_name -> casablanca.Miniblock
	27,  // 47: casablanca.GetStreamResponse.stream:type_name -> casablanca.StreamAndCookie
	6,   // 48: casablanca.GetStreamResponse.miniblocks:type_name -> casablanca.Miniblock
	6,   // 49: casablanca.GetMiniblocksResponse.miniblocks:type_name -> casablanca.Miniblock
	7,   // 50: casablanca.AddEventRequest.event:type_name -> casablanca.Envelope
	26,  // 51: casablanca.SyncStreamsRequest.sync_pos:type_name -> casablanca.SyncCookie
	27,  // 52: casablanca.SyncStreamsResponse.streams:type_name -> casablanca.StreamAndCookie
	47,  // 53: casablanca.SpacePayload.Snapshot.inception:type_name -> casablanca.SpacePayload.Inception
	50,  // 54: casablanca.SpacePayload.Snapshot.channels:type_name -> casablanca.SpacePayload.Snapshot.ChannelsEntry
	51,  // 55: casablanca.SpacePayload.Snapshot.memberships:type_name -> casablanca.SpacePayload.Snapshot.MembershipsEntry
	52,  // 56: casablanca.SpacePayload.Snapshot.usernames:type_name -> casablanca.SpacePayload.Snapshot.UsernamesEntry
	53,  // 57: casablanca.SpacePayload.Snapshot.displaynames:type_name -> casablanca.SpacePayload.Snapshot.DisplaynamesEntry
	18,  // 58: casablanca.SpacePayload.Inception.settings:type_name -> casablanca.StreamSettings
	2,   // 59: casablanca.SpacePayload.Channel.op:type_name -> casablanca.ChannelOp
	17,  // 60: casablanca.SpacePayload.Channel.origin_event:type_name -> casablanca.EventRef
	20,  // 61: casablanca.SpacePayload.Channel.channel_properties:type_name -> casablanca.EncryptedData
	0,   // 62: casablanca.SpacePayload.Username.op:type_name -> casablanca.UsernameOp
	20,  // 63: casablanca.SpacePayload.Username.username_properties:type_name -> casablanca.EncryptedData
	48,  // 64: casablanca.SpacePayload.Snapshot.ChannelsEntry.value:type_name -> casablanca.SpacePayload.Channel
	19,  // 65: casablanca.SpacePayload.Snapshot.MembershipsEntry.value:type_name -> casablanca.Membership
	49,  // 66: casablanca.SpacePayload.Snapshot.UsernamesEntry.value:type_name -> casablanca.SpacePayload.Username
	49,  // 67: casablanca.SpacePayload.Snapshot.DisplaynamesEntry.value:type_name -> casablanca.SpacePayload.Username
	55,  // 68: casablanca.ChannelPayload.Snapshot.inception:type_name -> casablanca.ChannelPayload.Inception
	57,  // 69: casablanca.ChannelPayload.Snapshot.memberships:type_name -> casablanca.ChannelPayload.Snapshot.MembershipsEntry
	20,  // 70: casablanca.ChannelPayload.Inception.channel_properties:type_name -> casablanca.EncryptedData
	18,  // 71: casablanca.ChannelPayload.Inception.settings:type_name -> casablanca.StreamSettings
	3,   // 72: casablanca.ChannelPayload.Receipt.origin_op:type_name -> casablanca.ToDeviceOp
	19,  // 73: casablanca.ChannelPayload.Snapshot.MembershipsEntry.value:type_name -> casablanca.Membership
	59,  // 74: casablanca.UserPayload.Snapshot.inception:type_name -> casablanca.UserPayload.Inception
	62,  // 75: casablanca.UserPayload.Snapshot.memberships:type_name -> casablanca.UserPayload.Snapshot.MembershipsEntry
	18,  // 76: casablanca.UserPayload.Inception.settings:type_name -> casablanca.StreamSettings
	17,  // 77: casablanca.UserPayload.UserMembership.origin_event:type_name -> casablanca.EventRef
	1,   // 78: casablanca.UserPayload.UserMembership.op:type_name -> casablanca.MembershipOp
	3,   // 79: casablanca.UserPayload.ToDevice.op:type_name -> casablanca.ToDeviceOp
	21,  // 80: casablanca.UserPayload.ToDevice.message:type_name -> casablanca.EncryptedDeviceData
	60,  // 81: casablanca.UserPayload.Snapshot.MembershipsEntry.value:type_name -> casablanca.UserPayload.UserMembership
	64,  // 82: casablanca.UserSettingsPayload.Snapshot.inception:type_name -> casablanca.UserSettingsPayload.Inception
	66,  // 83: casablanca.UserSettingsPayload.Snapshot.fully_read_markers:type_name -> casablanca.UserSettingsPayload.Snapshot.FullyReadMarkersEntry
	18,  // 84: casablanca.UserSettingsPayload.Inception.settings:type_name -> casablanca.StreamSettings
	20,  // 85: casablanca.UserSettingsPayload.FullyReadMarkers.content:type_name -> casablanca.EncryptedData
	65,  // 86: casablanca.UserSettingsPayload.Snapshot.FullyReadMarkersEntry.value:type_name -> casablanca.UserSettingsPayload.FullyReadMarkers
	68,  // 87: casablanca.UserDeviceKeyPayload.Snapshot.inception:type_name -> casablanca.UserDeviceKeyPayload.Inception
	70,  // 88: casablanca.UserDeviceKeyPayload.Snapshot.user_device_keys:type_name -> casablanca.UserDeviceKeyPayload.Snapshot.UserDeviceKeysEntry
	18,  // 89: casablanca.UserDeviceKeyPayload.Inception.settings:type_name -> casablanca.StreamSettings
	23,  // 90: casablanca.UserDeviceKeyPayload.UserDeviceKey.device_keys:type_name -> casablanca.DeviceKeys
	24,  // 91: casablanca.UserDeviceKeyPayload.UserDeviceKey.fallback_keys:type_name -> casablanca.FallbackKeys
	4,   // 92: casablanca.UserDeviceKeyPayload.UserDeviceKey.river_key_op:type_name -> casablanca.RiverKeyOp
	69,  // 93: casablanca.UserDeviceKeyPayload.Snapshot.UserDeviceKeysEntry.value:type_name -> casablanca.UserDeviceKeyPayload.UserDeviceKey
	72,  // 94: casablanca.MediaPayload.Snapshot.inception:type_name -> casablanca.MediaPayload.Inception
	18,  // 95: casablanca.MediaPayload.Inception.settings:type_name -> casablanca.StreamSettings
	22,  // 96: casablanca.EncryptedDeviceData.CiphertextEntry.value:type_name -> casablanca.EncryptedMessageEnvelope
	25,  // 97: casablanca.FallbackKeys.AlgoKeyIdEntry.value:type_name -> casablanca.Key
	28,  // 98: casablanca.StreamService.CreateStream:input_type -> casablanca.CreateStreamRequest
	30,  // 99: casablanca.StreamService.GetStream:input_type -> casablanca.GetStreamRequest
	32,  // 100: casablanca.StreamService.GetMiniblocks:input_type -> casablanca.GetMiniblocksRequest
	34,  // 101: casablanca.StreamService.AddEvent:input_type -> casablanca.AddEventRequest
	36,  // 102: casablanca.StreamService.SyncStreams:input_type -> casablanca.SyncStreamsRequest
	40,  // 103: casablanca.StreamService.LinkWallet:input_type -> casablanca.LinkWalletRequest
	44,  // 104: casablanca.StreamService.GetLinkWalletNonce:input_type -> casablanca.GetLinkWalletNonceRequest
	42,  // 105: casablanca.StreamService.GetLinkedWallets:input_type -> casablanca.GetLinkedWalletsRequest
	38,  // 106: casablanca.StreamService.Info:input_type -> casablanca.InfoRequest
	29,  // 107: casablanca.StreamService.CreateStream:output_type -> casablanca.CreateStreamResponse
	31,  // 108: casablanca.StreamService.GetStream:output_type -> casablanca.GetStreamResponse
	33,  // 109: casablanca.StreamService.GetMiniblocks:output_type -> casablanca.GetMiniblocksResponse
	35,  // 110: casablanca.StreamService.AddEvent:output_type -> casablanca.AddEventResponse
	37,  // 111: casablanca.StreamService.SyncStreams:output_type -> casablanca.SyncStreamsResponse
	41,  // 112: casablanca.StreamService.LinkWallet:output_type -> casablanca.LinkWalletResponse
	45,  // 113: casablanca.StreamService.GetLinkWalletNonce:output_type -> casablanca.GetLinkWalletNonceResponse
	43,  // 114: casablanca.StreamService.GetLinkedWallets:output_type -> casablanca.GetLinkedWalletsResponse
	39,  // 115: casablanca.StreamService.Info:output_type -> casablanca.InfoResponse
...
func file_protocol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protocol_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLinkWalletNonceRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_protocol_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLinkWalletNonceResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_protocol_proto_msgTypes[43].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SpacePayload_Username); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_protocol_proto_msgTypes[43].OneofWrappers = []interface{}{}
