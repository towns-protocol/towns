...
// ComputeTown is a free data retrieval call binding the contract method 0x16c5f784.
//
// Solidity: function computeTown(string townId, ((string,string,uint256,uint256,uint64,address,address,uint256,address),(bool,(address,uint256,bool,uint256[])[],address[]),string[]) membership) view returns(address)
...
// CreateTown is a paid mutator transaction binding the contract method 0xa7b4bca0.
//
// Solidity: function createTown((string,string,string,((string,string,uint256,uint256,uint64,address,address,uint256,address),(bool,(address,uint256,bool,uint256[])[],address[]),string[]),(string,string)) townInfo) returns(address)
