...
// MODULETYPE is a free data retrieval call binding the contract method 0x5775029f.
//
// Solidity: function MODULE_TYPE() view returns(string)
func (_LocalhostSpace *LocalhostSpaceCaller) MODULETYPE(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _LocalhostSpace.contract.Call(opts, &out, "MODULE_TYPE")
...
//
// Solidity: function MODULE_TYPE() view returns(string)
func (_LocalhostSpace *LocalhostSpaceSession) MODULETYPE() (string, error) {
	return _LocalhostSpace.Contract.MODULETYPE(&_LocalhostSpace.CallOpts)
}

// MODULETYPE is a free data retrieval call binding the contract method 0x5775029f.
//
// Solidity: function MODULE_TYPE() view returns(string)
func (_LocalhostSpace *LocalhostSpaceCallerSession) MODULETYPE() (string, error) {
	return _LocalhostSpace.Contract.MODULETYPE(&_LocalhostSpace.CallOpts)
}

// MODULEVERSION is a free data retrieval call binding the contract method 0x81ed9808.
//
// Solidity: function MODULE_VERSION() view returns(uint48)
func (_LocalhostSpace *LocalhostSpaceCaller) MODULEVERSION(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _LocalhostSpace.contract.Call(opts, &out, "MODULE_VERSION")
...
//
// Solidity: function MODULE_VERSION() view returns(uint48)
func (_LocalhostSpace *LocalhostSpaceSession) MODULEVERSION() (*big.Int, error) {
	return _LocalhostSpace.Contract.MODULEVERSION(&_LocalhostSpace.CallOpts)
}

// MODULEVERSION is a free data retrieval call binding the contract method 0x81ed9808.
//
// Solidity: function MODULE_VERSION() view returns(uint48)
func (_LocalhostSpace *LocalhostSpaceCallerSession) MODULEVERSION() (*big.Int, error) {
	return _LocalhostSpace.Contract.MODULEVERSION(&_LocalhostSpace.CallOpts)
}
...
func (_LocalhostSpace *LocalhostSpaceCaller) ContractURI(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _LocalhostSpace.contract.Call(opts, &out, "contractURI")
...
//
// Solidity: function contractURI() view returns(string)
func (_LocalhostSpace *LocalhostSpaceSession) ContractURI() (string, error) {
	return _LocalhostSpace.Contract.ContractURI(&_LocalhostSpace.CallOpts)
}

// ContractURI is a free data retrieval call binding the contract method 0xe8a3d485.
//
// Solidity: function contractURI() view returns(string)
func (_LocalhostSpace *LocalhostSpaceCallerSession) ContractURI() (string, error) {
	return _LocalhostSpace.Contract.ContractURI(&_LocalhostSpace.CallOpts)
}
...
func (_LocalhostSpace *LocalhostSpaceCaller) GetEntitlementModules(opts *bind.CallOpts) ([]DataTypesEntitlementModule, error) {
	var out []interface{}
	err := _LocalhostSpace.contract.Call(opts, &out, "getEntitlementModules")
...
//
// Solidity: function getEntitlementModules() view returns((string,address,string,bool)[] _entitlementModules)
func (_LocalhostSpace *LocalhostSpaceSession) GetEntitlementModules() ([]DataTypesEntitlementModule, error) {
	return _LocalhostSpace.Contract.GetEntitlementModules(&_LocalhostSpace.CallOpts)
}

// GetEntitlementModules is a free data retrieval call binding the contract method 0x0d029f75.
//
// Solidity: function getEntitlementModules() view returns((string,address,string,bool)[] _entitlementModules)
func (_LocalhostSpace *LocalhostSpaceCallerSession) GetEntitlementModules() ([]DataTypesEntitlementModule, error) {
	return _LocalhostSpace.Contract.GetEntitlementModules(&_LocalhostSpace.CallOpts)
}
...
func (_LocalhostSpace *LocalhostSpaceCaller) GetPermissionsByRoleId(opts *bind.CallOpts, _roleId *big.Int) ([]string, error) {
	var out []interface{}
...
//
// Solidity: function getPermissionsByRoleId(uint256 _roleId) view returns(string[])
func (_LocalhostSpace *LocalhostSpaceSession) GetPermissionsByRoleId(_roleId *big.Int) ([]string, error) {
...
//
// Solidity: function getPermissionsByRoleId(uint256 _roleId) view returns(string[])
func (_LocalhostSpace *LocalhostSpaceCallerSession) GetPermissionsByRoleId(_roleId *big.Int) ([]string, error) {
	return _LocalhostSpace.Contract.GetPermissionsByRoleId(&_LocalhostSpace.CallOpts, _roleId)
}
...
func (_LocalhostSpace *LocalhostSpaceTransactor) RemovePermissionsFromRole(opts *bind.TransactOpts, _roleId *big.Int, _permissions []string) (*types.Transaction, error) {
	return _LocalhostSpace.contract.Transact(opts, "removePermissionsFromRole", _roleId, _permissions)
}

// RemovePermissionsFromRole is a paid mutator transaction binding the contract method 0x9a8e4c3e.
//
// Solidity: function removePermissionsFromRole(uint256 _roleId, string[] _permissions) returns()
func (_LocalhostSpace *LocalhostSpaceSession) RemovePermissionsFromRole(_roleId *big.Int, _permissions []string) (*types.Transaction, error) {
	return _LocalhostSpace.Contract.RemovePermissionsFromRole(&_LocalhostSpace.TransactOpts, _roleId, _permissions)
}

// RemovePermissionsFromRole is a paid mutator transaction binding the contract method 0x9a8e4c3e.
//
// Solidity: function removePermissionsFromRole(uint256 _roleId, string[] _permissions) returns()
func (_LocalhostSpace *LocalhostSpaceTransactorSession) RemovePermissionsFromRole(_roleId *big.Int, _permissions []string) (*types.Transaction, error) {
	return _LocalhostSpace.Contract.RemovePermissionsFromRole(&_LocalhostSpace.TransactOpts, _roleId, _permissions)
}
...
func (_LocalhostSpace *LocalhostSpaceTransactor) SetContractURI(opts *bind.TransactOpts, _uri string) (*types.Transaction, error) {
	return _LocalhostSpace.contract.Transact(opts, "setContractURI", _uri)
}

// SetContractURI is a paid mutator transaction binding the contract method 0x938e3d7b.
//
// Solidity: function setContractURI(string _uri) returns()
func (_LocalhostSpace *LocalhostSpaceSession) SetContractURI(_uri string) (*types.Transaction, error) {
	return _LocalhostSpace.Contract.SetContractURI(&_LocalhostSpace.TransactOpts, _uri)
}

// SetContractURI is a paid mutator transaction binding the contract method 0x938e3d7b.
//
// Solidity: function setContractURI(string _uri) returns()
func (_LocalhostSpace *LocalhostSpaceTransactorSession) SetContractURI(_uri string) (*types.Transaction, error) {
	return _LocalhostSpace.Contract.SetContractURI(&_LocalhostSpace.TransactOpts, _uri)
}
...
// LocalhostSpaceContractURIUpdatedIterator is returned from FilterContractURIUpdated and is used to iterate over the raw logs and unpacked data for ContractURIUpdated events raised by the LocalhostSpace contract.
type LocalhostSpaceContractURIUpdatedIterator struct {
	Event *LocalhostSpaceContractURIUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *LocalhostSpaceContractURIUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(LocalhostSpaceContractURIUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *LocalhostSpaceContractURIUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *LocalhostSpaceContractURIUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// LocalhostSpaceContractURIUpdated represents a ContractURIUpdated event raised by the LocalhostSpace contract.
type LocalhostSpaceContractURIUpdated struct {
	PrevURI string
	NewURI  string
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_LocalhostSpace *LocalhostSpaceFilterer) FilterContractURIUpdated(opts *bind.FilterOpts) (*LocalhostSpaceContractURIUpdatedIterator, error) {

	logs, sub, err := _LocalhostSpace.contract.FilterLogs(opts, "ContractURIUpdated")
	if err != nil {
		return nil, err
	}
	return &LocalhostSpaceContractURIUpdatedIterator{contract: _LocalhostSpace.contract, event: "ContractURIUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ContractURIUpdated(string prevURI, string newURI)
func (_LocalhostSpace *LocalhostSpaceFilterer) WatchContractURIUpdated(opts *bind.WatchOpts, sink chan<- *LocalhostSpaceContractURIUpdated) (event.Subscription, error) {

	logs, sub, err := _LocalhostSpace.contract.WatchLogs(opts, "ContractURIUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(LocalhostSpaceContractURIUpdated)
				if err := _LocalhostSpace.contract.UnpackLog(event, "ContractURIUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ContractURIUpdated(string prevURI, string newURI)
func (_LocalhostSpace *LocalhostSpaceFilterer) ParseContractURIUpdated(log types.Log) (*LocalhostSpaceContractURIUpdated, error) {
	event := new(LocalhostSpaceContractURIUpdated)
	if err := _LocalhostSpace.contract.UnpackLog(event, "ContractURIUpdated", log); err != nil {
		return nil, err
	}
