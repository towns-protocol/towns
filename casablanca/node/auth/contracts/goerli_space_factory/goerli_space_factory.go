...
func (_GoerliSpaceFactory *GoerliSpaceFactoryCaller) GetSpaceAddressByNetworkId(opts *bind.CallOpts, spaceNetworkId string) (common.Address, error) {
	var out []interface{}
	err := _GoerliSpaceFactory.contract.Call(opts, &out, "getSpaceAddressByNetworkId", spaceNetworkId)
...
//
// Solidity: function getSpaceAddressByNetworkId(string spaceNetworkId) view returns(address)
func (_GoerliSpaceFactory *GoerliSpaceFactorySession) GetSpaceAddressByNetworkId(spaceNetworkId string) (common.Address, error) {
	return _GoerliSpaceFactory.Contract.GetSpaceAddressByNetworkId(&_GoerliSpaceFactory.CallOpts, spaceNetworkId)
}

// GetSpaceAddressByNetworkId is a free data retrieval call binding the contract method 0x96dc21e4.
//
// Solidity: function getSpaceAddressByNetworkId(string spaceNetworkId) view returns(address)
func (_GoerliSpaceFactory *GoerliSpaceFactoryCallerSession) GetSpaceAddressByNetworkId(spaceNetworkId string) (common.Address, error) {
	return _GoerliSpaceFactory.Contract.GetSpaceAddressByNetworkId(&_GoerliSpaceFactory.CallOpts, spaceNetworkId)
}
