...
contract DeployCouncilOfZionNFTScript is Script {
    ...
    function run() external {
        ...
        data[0] = keccak256(abi.encodePacked(first, Strings.toString(1)));
        data[1] = keccak256(abi.encodePacked(second, Strings.toString(1)));
        data[2] = keccak256(abi.encodePacked(third, Strings.toString(0)));
        data[3] = keccak256(abi.encodePacked(fourth, Strings.toString(0)));
