...
contract MockPluginResolver is ISchemaResolver {
    ...
    function attest(DataTypes.Attestation calldata attestation) external payable returns (bool) {
    ...
    function revoke(DataTypes.Attestation calldata attestation) external payable returns (bool) {
