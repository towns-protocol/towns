...
contract ZioneerTest is Test {
  ...
  function copyAllowedAddressesList(Zioneer z) internal view returns (address[] memory) {
  ...
  */
  ...
  function testSetAllowedInitialState() public {
    address[] memory currentAllowedAddressesList = copyAllowedAddressesList(nft);
