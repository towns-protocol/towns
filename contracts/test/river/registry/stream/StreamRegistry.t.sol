    ...
    IStreamRegistryBase
{
    ...
    TestStream internal SAMPLE_STREAM = TestStream(
        ...
        givenNodesAreRegistered(nodeOperator, nodes)
    {
        ...
        streamRegistry.addStream(
            testStream.streamId, testStream.genesisMiniblockHash, streamToCreate
        );
    ...
    function test_placeStreamOnNode() public {
        ...
        assertEq(
            uint8(uint256(streamUpdatedLog.topics[1])), uint8(StreamEventType.PlacementUpdated)
        );
