...
/**
 * @author  HNT Labs
 * @title   Enums, Events and Errors for the NodeStatusBase contract.
 */

interface INodeStatusBase {
  enum NodeStatus {
   ...
   */
  error NodeStatusBase__InvalidSignal();
}

/**
 * @author HNT Labs
 * @title  Interface for the NodeStatusFacet.
 */
interface INodeStatus is INodeStatusBase {
