...
import {IAccessControlList} from "./IAccessControlList.sol";
...
contract AccessControlListFacet is
  ...
  Facet
{
  function __AccessControlListFacet_init() external {
    __AccessControlListFacet_init_unchained();
  }

  function __AccessControlListFacet_init_unchained() internal {
    _addInterface(type(IAccessControlList).interfaceId);
  }
