...
<Step title="Testnet Upgrade">
    ...
    <br />
    <Note>Operators are encouraged to monitor the river [repo](https://github.com/towns-protocol/towns) for `testnet*` prefixed tags to upgrade nodes running in testnet.</Note>
</Step>
