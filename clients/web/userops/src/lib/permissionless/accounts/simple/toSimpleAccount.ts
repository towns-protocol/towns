...
import { EthereumProvider, toOwner } from './toOwner'
...
const getFactoryAddress = (entryPointVersion: '0.6' | '0.7', factoryAddress?: Address): Address => {
...
export type SimpleSmartAccountImplementation<entryPointVersion extends '0.6' | '0.7' = '0.7'> =
    Assign<
...
export type ToSimpleSmartAccountReturnType<entryPointVersion extends '0.6' | '0.7' = '0.7'> =
 ...
 */
export async function toSimpleSmartAccount<entryPointVersion extends '0.6' | '0.7'>(
    ...
    const entryPoint = {
        ...
        abi:
            (parameters.entryPoint?.version ?? '0.7') === '0.6' ? entryPoint06Abi : entryPoint07Abi,
