...
describe('inviteToSpace', () => {
    ...
    test('user can receive an invite, display it, accept it', async () => {
        // create clients
        ...
        // create a space
        const janesSpaceId_1 = await jane.createSpace({
            name: 'janes_space_1',
            visibility: RoomVisibility.Private,
        })
        // create a second space
        const janesSpaceId_2 = await jane.createSpace({
            name: 'janes_space_2',
            visibility: RoomVisibility.Private,
        })
        // and channel
        const janesChannelId_2 = await jane.createChannel({
            name: 'janes_channel',
            visibility: RoomVisibility.Private,
        ...
        await waitFor(() => expect(allInvites).toHaveTextContent(janesSpaceId_1.matrixRoomId))
        ...
        await waitFor(() => expect(allInvites).toHaveTextContent(janesSpaceId_2.matrixRoomId))
        await waitFor(() => expect(allInvites).toHaveTextContent(janesChannelId_2.matrixRoomId))
