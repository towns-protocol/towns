...
describe('inviteToSpace', () => {
    ...
    test('user can receive an invite, display it, and accept it', async () => {
        ...
        // Wrap inside act() to makes sure all updates related to these “components”
        ...
        // This call triggers react re-rendering. Wrap inside act() to
        // avoid warnings.
        await act(async () => {
