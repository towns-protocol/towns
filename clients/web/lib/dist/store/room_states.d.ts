...
export declare function updateMembership(state: StoreStates, roomId: string, userId: string, membership: Membership): StoreStates | {
    rooms: {
        [x: string]: Room;
    };
};
export declare function leaveRoom(state: StoreStates, roomId: string, userId: string): StoreStates | {
    rooms: {
        [x: string]: Room;
    };
};
export declare function joinRoom(state: StoreStates, roomId: string, userId: string): StoreStates | {
    rooms: {
        [x: string]: Room;
    };
};
