...
const use_web3_1 = require("../hooks/use-web3");
...
function MatrixContextProvider(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(use_web3_1.Web3Provider, { children: (0, jsx_runtime_1.jsx)(exports.MatrixContext.Provider, Object.assign({ value: matrixClient }, { children: props.children }), void 0) }, void 0));
}
