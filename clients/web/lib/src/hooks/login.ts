...
export interface PublicKeyEthereumHashFields {
  // Simplified version of https://eips.ethereum.org/EIPS/eip-4361
  domain: string; // is the RFC 3986 authority that is requesting the signing.
...
export function getChainIdEip155(chainId: string): string {
  // ChainId should not have 0x prefix.
  // https://eips.ethereum.org/EIPS/eip-155
  return chainId.replace(/0x/g, "");
}
