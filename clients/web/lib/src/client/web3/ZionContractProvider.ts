...
export class ZionContractProvider<T> {
    ...
    get unsigned(): T {
        ...
        return new ethers.Contract(this.address, this.contractInterface, provider) as unknown as T
    }
    ...
    get signed() {
        ...
        return new ethers.Contract(this.address, this.contractInterface, signer) as unknown as T
    }
}
