  ...
  useEffect(() => {
    ...
    function positionMenu() {
      ...
      if (rootElement !== null && resolution !== null) {
        ...
        const isBottom = top + height + MAX_HEIGHT > window.innerHeight;
        const offset = isBottom ? top - MARGIN : top + height + MARGIN;
        // containerDiv.style.border = "1px solid pink";
        containerDiv.style.top = `${offset + window.pageYOffset}px`;
