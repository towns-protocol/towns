...
./bin/gen-bindings-remove-struct core/contracts/base/deploy/mock_wallet_link.go IWalletLinkBaseLinkedWalletData,IWalletLinkBaseNonEVMLinkedWalletData,IWalletLinkBaseWalletType,IWalletLinkBaseWalletQueryOptions,IWalletLinkBaseWalletData,IWalletLinkBaseVMSpecificData
