...
TASK_DEFINITION_FAMILY="${ENVIRONMENT}-dendrite-fargate"
...
TASK_DEF_WITH_UPDATED_IMAGE="$( jq '.containerDefinitions[0].image = "docker.io/herenotthere/dendrite-monolith:'${DOCKER_IMAGE_TAG}'"' <<< ${TASK_DEF_WITHOUT_UNWANTED_KEYS} )"
