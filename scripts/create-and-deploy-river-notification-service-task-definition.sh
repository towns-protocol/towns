...
function set_env() {
    export TASK_DEFINITION_FAMILY="river-notification-service-${ENVIRONMENT_NAME}-fargate"
    ...
    export SERVICE_NAME="river-notification-service-${ENVIRONMENT_NAME}-fargate-service"
