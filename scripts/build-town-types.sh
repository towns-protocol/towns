...
yarn typechain --target=ethers-v5 "contracts/out/**/?(IDiamond|IDiamondCut|ITownArchitect|IProxyManager|IPausable|IEntitlements|IChannel|IRoles|ITokenEntitlement|TokenPausableFacet).json" --out-dir "packages/generated/${CHAIN}/v3/typings"

mkdir -p $ABI_DIR && cp -a contracts/out/{Diamond,DiamondCut,TownArchitect,ProxyManager,Pausable,Entitlements,Channels,Roles,TokenEntitlement,TokenPausableFacet}.sol/* "$ABI_DIR"
