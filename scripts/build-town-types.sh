...
yarn typechain --target=ethers-v5 "packages/contracts/out/**/?(IDiamond|IDiamondCut|ITownArchitect|IProxyManager|IPausable|IEntitlements|IChannel|IRole|ITokenEntitlement|IERC721|Permissions).json" --out-dir "packages/generated/${CHAIN}/v3/typings"
