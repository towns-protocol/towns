...
yarn typechain --target=ethers-v5 "contracts/out/**/?(IDiamond|IDiamondCut|ITownArchitect|IProxyManager|IPausable|IEntitlements|IChannel|IRoles|TokenEntitlement|OwnableFacet|TokenPausableFacet|UserEntitlement|TownFacet).json" --out-dir "packages/generated/${CHAIN}/v3/typings"

mkdir -p $ABI_DIR && cp -a contracts/out/{Diamond,DiamondCutFacet,TownArchitect,ProxyManager,Pausable,Entitlements,Channels,Roles,OwnableFacet,TokenEntitlement,TokenPausableFacet,UserEntitlement,TownFacet}.sol/* "$ABI_DIR"
