...
yarn typechain --target=ethers-v5 "contracts/out/**/?(IDiamond|IDiamondCut|ITownArchitect|IProxyManager|IPausable|IEntitlements|IChannel|IRoles|TokenEntitlement|OwnableFacet|TokenPausableFacet|UserEntitlement).json" --out-dir "packages/generated/${CHAIN}/v3/typings"

mkdir -p $ABI_DIR && cp -a contracts/out/{Diamond,DiamondCut,TownArchitect,ProxyManager,Pausable,Entitlements,Channels,Roles,OwnableFacet,TokenEntitlement,TokenPausableFacet,UserEntitlement}.sol/* "$ABI_DIR"
