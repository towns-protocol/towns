...
yarn typechain --target=ethers-v5 "contracts/out/**/?(IDiamond|IDiamondCut|ITownArchitect|IProxyManager|IPausable|IEntitlements|IChannel|IRoles|ITokenEntitlement|IERC721|Permissions|TokenPausableFacet).json" --out-dir "packages/generated/${CHAIN}/v3/typings"

mkdir -p $ABI_DIR && cp -a contracts/out/{Diamond,DiamondCut,TownArchitect,ProxyManager,Pausable,Entitlements,Channels,Roles,TokenEntitlement,ERC721,Permissions,TokenPausableFacet}.sol/* "$ABI_DIR"
