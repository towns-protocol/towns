# Variable: IRuleEntitlementAbi

```ts
IRuleEntitlementAbi: readonly [{
  inputs: readonly [];
  name: "description";
  outputs: readonly [{
     internalType: "string";
...
Defined in: [packages/web3/src/space/entitlements/RuleEntitlementShim.ts:12](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/entitlements/RuleEntitlementShim.ts#L12)
