# Class: ISpaceArchitectShim

Defined in: [packages/web3/src/space-registrar/ISpaceArchitectShim.ts:10](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space-registrar/ISpaceArchitectShim.ts#L10)
...
```ts
new ISpaceArchitectShim(address, provider): ISpaceArchitectShim;
```

Defined in: [packages/web3/src/space-registrar/ISpaceArchitectShim.ts:11](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space-registrar/ISpaceArchitectShim.ts#L11)
...
`FnParams` *extends* 
  \| \[`PromiseOrValue`\<`string`\>, `PromiseOrValue`\<`string`\>, `PromiseOrValue`\<`string`\>, `PromiseOrValue`\<`string`\>, `Overrides` & `object`\]
  \| \[`CallOverrides`\]
  \| \[`CallOverrides`\]
...
`Args` *extends* 
  ...
  \| \[`PromiseOrValue`\<`string`\>, `CallOverrides`\]
  \| \[`PromiseOrValue`\<`string`\>, `Overrides` & `object`\]
  \| \[`PromiseOrValue`\<`string`\>, `PromiseOrValue`\<`string`\>, `PromiseOrValue`\<`string`\>, `PromiseOrValue`\<`string`\>, `Overrides` & `object`\] = `Parameters`\<`object`\[`FnName`\]\>
...
### getSpaceAddressFromLog()

```ts
getSpaceAddressFromLog(log, userId): undefined | string;
```

Defined in: [packages/web3/src/space-registrar/ISpaceArchitectShim.ts:15](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space-registrar/ISpaceArchitectShim.ts#L15)
