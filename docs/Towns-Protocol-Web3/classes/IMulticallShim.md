# Class: IMulticallShim

Defined in: [packages/web3/src/space/IMulticallShim.ts:7](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/IMulticallShim.ts#L7)
...
```ts
new IMulticallShim(address, provider): IMulticallShim;
```

Defined in: [packages/web3/src/space/IMulticallShim.ts:8](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/IMulticallShim.ts#L8)
...
`FnParams` *extends* \[`PromiseOrValue`\<`BytesLike`\>[], `Overrides` & `object`\]
...
`FnName` *extends* `"multicall"` = `"multicall"`

##### Args

`Args` *extends* \[`PromiseOrValue`\<`BytesLike`\>[], `Overrides` & `object`\] = `Parameters`\<`object`\[`FnName`\]\>
...
```ts
makeCalls<T>(args): Promise<T[]>;
```

Defined in: [packages/web3/src/space/IMulticallShim.ts:12](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/IMulticallShim.ts#L12)
