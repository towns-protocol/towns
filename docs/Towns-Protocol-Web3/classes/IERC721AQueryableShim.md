# Class: IERC721AQueryableShim

Defined in: [packages/web3/src/erc-721/IERC721AQueryableShim.ts:7](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/erc-721/IERC721AQueryableShim.ts#L7)
...
```ts
new IERC721AQueryableShim(address, provider): IERC721AQueryableShim;
```

Defined in: [packages/web3/src/erc-721/IERC721AQueryableShim.ts:8](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/erc-721/IERC721AQueryableShim.ts#L8)
...
```ts
connect: Connect<IERC721AQueryable>;
```
...
`Args` *extends* 
  ...
  \| \[`PromiseOrValue`\<`BigNumberish`\>[], `CallOverrides`\]
  \| \[`PromiseOrValue`\<`string`\>, `CallOverrides`\]
  \| \[`PromiseOrValue`\<`string`\>, `PromiseOrValue`\<`BigNumberish`\>, `PromiseOrValue`\<`BigNumberish`\>, `CallOverrides`\] = `Parameters`\<`object`\[`FnName`\]\>
...
```ts
write(signer): IERC721AQueryable;
```
