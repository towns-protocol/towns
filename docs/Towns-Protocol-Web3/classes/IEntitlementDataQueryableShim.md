# Class: IEntitlementDataQueryableShim

Defined in: [packages/web3/src/space/IEntitlementDataQueryableShim.ts:8](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/IEntitlementDataQueryableShim.ts#L8)
...
```ts
new IEntitlementDataQueryableShim(address, provider): IEntitlementDataQueryableShim;
```

Defined in: [packages/web3/src/space/IEntitlementDataQueryableShim.ts:9](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/IEntitlementDataQueryableShim.ts#L9)
...
```ts
connect: Connect<IEntitlementDataQueryable>;
```
...
`FnParams` *extends* 
  \| \[`PromiseOrValue`\<`BytesLike`\>, `PromiseOrValue`\<`string`\>, `CallOverrides`\]
  \| \[`PromiseOrValue`\<`BytesLike`\>, `PromiseOrValue`\<`BigNumberish`\>, `CallOverrides`\]
...
```ts
write(signer): IEntitlementDataQueryable;
```
