# Class: OwnableFacetShim

Defined in: [packages/web3/src/space/OwnableFacetShim.ts:19](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/OwnableFacetShim.ts#L19)
...
```ts
new OwnableFacetShim(address, provider): OwnableFacetShim;
```

Defined in: [packages/web3/src/space/OwnableFacetShim.ts:22](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/OwnableFacetShim.ts#L22)
...
`FnName` *extends* `"owner"` \| `"__Ownable_init"` \| `"transferOwnership"`
...
`FnName` *extends* `"owner"` \| `"__Ownable_init"` \| `"transferOwnership"` = `"owner"` \| `"__Ownable_init"` \| `"transferOwnership"`
...
Defined in: [packages/web3/src/space/OwnableFacetShim.ts:30](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/OwnableFacetShim.ts#L30)
