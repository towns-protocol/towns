# Class: IMembershipMetadataShim

Defined in: [packages/web3/src/space/IMembershipMetadataShim.ts:7](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/IMembershipMetadataShim.ts#L7)
...
```ts
new IMembershipMetadataShim(address, provider): IMembershipMetadataShim;
```

Defined in: [packages/web3/src/space/IMembershipMetadataShim.ts:8](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/IMembershipMetadataShim.ts#L8)
...
```ts
connect: Connect<IMembershipMetadata>;
```
...
`FnName` *extends* `"tokenURI"` \| `"refreshMetadata"`
...
`FnName` *extends* `"tokenURI"` \| `"refreshMetadata"` = `"tokenURI"` \| `"refreshMetadata"`

##### Args

`Args` *extends* 
  \| \[`Overrides` & `object`\]
  \| \[`PromiseOrValue`\<`BigNumberish`\>, `CallOverrides`\] = `Parameters`\<`object`\[`FnName`\]\>
...
```ts
write(signer): IMembershipMetadata;
```
