...
Defined in: [packages/web3/src/space/IBanningShim.ts:7](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/IBanningShim.ts#L7)
...
```ts
new IBanningShim(address, provider): IBanningShim;
```

Defined in: [packages/web3/src/space/IBanningShim.ts:8](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/IBanningShim.ts#L8)
...
`FnName` *extends* `"ban"` \| `"banned"` \| `"isBanned"` \| `"unban"`
...
`FnName` *extends* `"ban"` \| `"banned"` \| `"isBanned"` \| `"unban"` = `"ban"` \| `"banned"` \| `"isBanned"` \| `"unban"`
...
`Args` *extends* 
  ...
  \| \[`CallOverrides`\]
  \| \[`PromiseOrValue`\<`BigNumberish`\>, `CallOverrides`\]
  \| \[`PromiseOrValue`\<`BigNumberish`\>, `Overrides` & `object`\] = `Parameters`\<`object`\[`FnName`\]\>
