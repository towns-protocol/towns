# Class: IEntitlementsShim

Defined in: [packages/web3/src/space/IEntitlementsShim.ts:22](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/IEntitlementsShim.ts#L22)
...
```ts
new IEntitlementsShim(address, provider): IEntitlementsShim;
```

Defined in: [packages/web3/src/space/IEntitlementsShim.ts:28](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/IEntitlementsShim.ts#L28)
...
```ts
connect: Connect<EntitlementsManager>;
```
...
`FnParams` *extends* 
  ...
  \| \[`CallOverrides`\]
  \| \[`PromiseOrValue`\<`BytesLike`\>, `PromiseOrValue`\<`string`\>, `PromiseOrValue`\<`string`\>, `CallOverrides`\]
...
```ts
getEntitlements(): Promise<EntitlementStructOutput[]>;
```

Defined in: [packages/web3/src/space/IEntitlementsShim.ts:36](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/IEntitlementsShim.ts#L36)

#### Returns

`Promise`\<[`EntitlementStructOutput`](../namespaces/IEntitlementsBase/type-aliases/EntitlementStructOutput.md)[]\>
...
```ts
write(signer): EntitlementsManager;
```
