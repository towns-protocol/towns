# Class: TokenPausableFacetShim

Defined in: [packages/web3/src/space/TokenPausableFacetShim.ts:7](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/TokenPausableFacetShim.ts#L7)
...
```ts
new TokenPausableFacetShim(address, provider): TokenPausableFacetShim;
```

Defined in: [packages/web3/src/space/TokenPausableFacetShim.ts:8](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/web3/src/space/TokenPausableFacetShim.ts#L8)
...
```ts
connect: Connect<TokenPausableFacet>;
```
...
`FnName` *extends* `"__Pausable_init"` \| `"pause"` \| `"paused"` \| `"unpause"`
...
`FnName` *extends* `"__Pausable_init"` \| `"pause"` \| `"paused"` \| `"unpause"` = `"__Pausable_init"` \| `"pause"` \| `"paused"` \| `"unpause"`
...
`Args` *extends* 
  ...
  \| \[`Overrides` & `object`\]
  \| \[`CallOverrides`\]
  \| \[`Overrides` & `object`\] = `Parameters`\<`object`\[`FnName`\]\>
...
```ts
write(signer): TokenPausableFacet;
```
