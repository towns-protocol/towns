...
[`Client`](../classes/Client.md).[`getStreamEx`](../classes/Client.md#getstreamex)
...
[`Client`](../classes/Client.md).[`listeners`](../classes/Client.md#listeners)
...
[`Client`](../classes/Client.md).[`makeEventAndAddToStream`](../classes/Client.md#makeeventandaddtostream)
...
[`Client`](../classes/Client.md).[`makeEventWithHashAndAddToStream`](../classes/Client.md#makeeventwithhashandaddtostream)
...
[`Client`](../classes/Client.md).[`makeMediaEventWithHashAndAddToMediaStream`](../classes/Client.md#makemediaeventwithhashandaddtomediastream)
...
[`Client`](../classes/Client.md).[`off`](../classes/Client.md#off)
...
[`Client`](../classes/Client.md).[`on`](../classes/Client.md#on)
...
[`Client`](../classes/Client.md).[`once`](../classes/Client.md#once)
...
[`Client`](../classes/Client.md).[`onNetworkStatusChanged`](../classes/Client.md#onnetworkstatuschanged)
...
[`Client`](../classes/Client.md).[`pin`](../classes/Client.md#pin)
...
[`Client`](../classes/Client.md).[`prependListener`](../classes/Client.md#prependlistener)
...
[`Client`](../classes/Client.md).[`prependOnceListener`](../classes/Client.md#prependoncelistener)
...
[`Client`](../classes/Client.md).[`rawListeners`](../classes/Client.md#rawlisteners)
...
[`Client`](../classes/Client.md).[`redactMessage`](../classes/Client.md#redactmessage)
...
[`Client`](../classes/Client.md).[`removeAllListeners`](../classes/Client.md#removealllisteners)
...
[`Client`](../classes/Client.md).[`removeListener`](../classes/Client.md#removelistener)
...
[`Client`](../classes/Client.md).[`removeUser`](../classes/Client.md#removeuser)
...
[`Client`](../classes/Client.md).[`resetCrypto`](../classes/Client.md#resetcrypto)
...
[`Client`](../classes/Client.md).[`retrySendMessage`](../classes/Client.md#retrysendmessage)
...
[`Client`](../classes/Client.md).[`scrollback`](../classes/Client.md#scrollback)
...
[`Client`](../classes/Client.md).[`sendChannelMessage`](../classes/Client.md#sendchannelmessage)
...
[`Client`](../classes/Client.md).[`sendChannelMessage_Edit`](../classes/Client.md#sendchannelmessage_edit)
...
[`Client`](../classes/Client.md).[`sendChannelMessage_Edit_Text`](../classes/Client.md#sendchannelmessage_edit_text)
...
[`Client`](../classes/Client.md).[`sendChannelMessage_GM`](../classes/Client.md#sendchannelmessage_gm)
...
[`Client`](../classes/Client.md).[`sendChannelMessage_Image`](../classes/Client.md#sendchannelmessage_image)
...
[`Client`](../classes/Client.md).[`sendChannelMessage_Reaction`](../classes/Client.md#sendchannelmessage_reaction)
...
[`Client`](../classes/Client.md).[`sendChannelMessage_Redaction`](../classes/Client.md#sendchannelmessage_redaction)
...
[`Client`](../classes/Client.md).[`sendChannelMessage_Text`](../classes/Client.md#sendchannelmessage_text)
...
[`Client`](../classes/Client.md).[`sendFullyReadMarkers`](../classes/Client.md#sendfullyreadmarkers)
...
[`Client`](../classes/Client.md).[`sendMediaPayload`](../classes/Client.md#sendmediapayload)
...
[`Client`](../classes/Client.md).[`sendMessage`](../classes/Client.md#sendmessage)
...
[`Client`](../classes/Client.md).[`setDisplayName`](../classes/Client.md#setdisplayname)
...
[`Client`](../classes/Client.md).[`setEnsAddress`](../classes/Client.md#setensaddress)
...
[`Client`](../classes/Client.md).[`setHighPriorityStreams`](../classes/Client.md#sethighprioritystreams)
...
[`Client`](../classes/Client.md).[`setMaxListeners`](../classes/Client.md#setmaxlisteners)
...
[`Client`](../classes/Client.md).[`setNft`](../classes/Client.md#setnft)
...
[`Client`](../classes/Client.md).[`setSpaceImage`](../classes/Client.md#setspaceimage)
...
[`Client`](../classes/Client.md).[`setStreamEncryptionAlgorithm`](../classes/Client.md#setstreamencryptionalgorithm)
...
[`Client`](../classes/Client.md).[`setUserBio`](../classes/Client.md#setuserbio)
...
[`Client`](../classes/Client.md).[`setUsername`](../classes/Client.md#setusername)
...
[`Client`](../classes/Client.md).[`setUserProfileImage`](../classes/Client.md#setuserprofileimage)
...
[`Client`](../classes/Client.md).[`startSync`](../classes/Client.md#startsync)
...
[`Client`](../classes/Client.md).[`stop`](../classes/Client.md#stop)
...
[`Client`](../classes/Client.md).[`stopSync`](../classes/Client.md#stopsync)
...
`undefined` \| [`SyncedStream`](../classes/SyncedStream.md)

#### Inherited from

[`Client`](../classes/Client.md).[`stream`](../classes/Client.md#stream)
...
[`Client`](../classes/Client.md).[`unpin`](../classes/Client.md#unpin)
...
[`Client`](../classes/Client.md).[`updateChannel`](../classes/Client.md#updatechannel)
...
[`Client`](../classes/Client.md).[`updateChannelAutojoin`](../classes/Client.md#updatechannelautojoin)
...
[`Client`](../classes/Client.md).[`updateChannelHideUserJoinLeaveEvents`](../classes/Client.md#updatechannelhideuserjoinleaveevents)
...
[`Client`](../classes/Client.md).[`updateGDMChannelProperties`](../classes/Client.md#updategdmchannelproperties)
...
[`Client`](../classes/Client.md).[`updateUserBlock`](../classes/Client.md#updateuserblock)
...
[`Client`](../classes/Client.md).[`uploadDeviceKeys`](../classes/Client.md#uploaddevicekeys)
...
[`Client`](../classes/Client.md).[`userDeviceKey`](../classes/Client.md#userdevicekey)
...
[`Client`](../classes/Client.md).[`waitForStream`](../classes/Client.md#waitforstream)
