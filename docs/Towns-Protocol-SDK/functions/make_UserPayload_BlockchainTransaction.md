# Function: make\_UserPayload\_BlockchainTransaction()

```ts
function make_UserPayload_BlockchainTransaction(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:302](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L302)
