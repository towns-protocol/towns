# Function: make\_UserInboxPayload\_Ack()

```ts
function make_UserInboxPayload_Ack(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:659](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L659)
...
from field: int64 miniblock_num = 2;
