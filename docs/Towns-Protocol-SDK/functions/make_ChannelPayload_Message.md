# Function: make\_ChannelPayload\_Message()

```ts
function make_ChannelPayload_Message(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:805](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L805)
