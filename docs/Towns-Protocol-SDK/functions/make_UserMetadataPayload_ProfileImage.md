# Function: make\_UserMetadataPayload\_ProfileImage()

```ts
function make_UserMetadataPayload_ProfileImage(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:687](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L687)
