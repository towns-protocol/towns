# Function: make\_DMChannelPayload\_Inception()

```ts
function make_DMChannelPayload_Inception(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:514](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L514)
...
from field: bytes first_party_address = 2;
...
from field: bytes second_party_address = 3;
