# Function: make\_UserPayload\_UserMembershipAction()

```ts
function make_UserPayload_UserMembershipAction(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:288](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L288)
...
from field: river.MembershipOp op = 3;
...
from field: optional river.MembershipReason reason = 5;
...
from field: optional bytes stream_parent_id = 4;
