# Function: make\_UserMetadataPayload\_Inception()

```ts
function make_UserMetadataPayload_Inception(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:617](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L617)
...
from field: river.StreamSettings settings = 2;
