# Function: make\_GDMChannelPayload\_Inception()

```ts
function make_GDMChannelPayload_Inception(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:547](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L547)
...
from field: river.EncryptedData channel_properties = 2;

#### channelProperties.algorithm
...
from field: string algorithm = 2;

#### channelProperties.checksum?
...
from field: optional string checksum = 5;

#### channelProperties.ciphertext
...
from field: string ciphertext = 1;

#### channelProperties.ciphertextBytes
...
from field: bytes ciphertext_bytes = 8;

#### channelProperties.ivBytes
...
from field: bytes iv_bytes = 9;

#### channelProperties.refEventId?
...
from field: optional string ref_event_id = 6;

#### channelProperties.senderKey
...
from field: string sender_key = 3;

#### channelProperties.sessionId
...
from field: string session_id = 4;

#### channelProperties.sessionIdBytes
...
from field: bytes session_id_bytes = 10;

#### channelProperties.version
...
from field: river.EncryptedDataVersion version = 11;
...
from field: river.StreamSettings settings = 3;

#### settings.disableMiniblockCreation
