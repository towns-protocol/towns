# Function: make\_SpacePayload\_ChannelUpdate()

```ts
function make_SpacePayload_ChannelUpdate(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:715](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L715)
...
from field: river.ChannelOp op = 1;
...
from field: river.EventRef origin_event = 3;
...
from field: river.SpacePayload.ChannelSettings settings = 6;
...
#### settings.hideUserJoinLeaveEvents
