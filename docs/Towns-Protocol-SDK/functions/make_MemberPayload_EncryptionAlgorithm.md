# Function: make\_MemberPayload\_EncryptionAlgorithm()

```ts
function make_MemberPayload_EncryptionAlgorithm(content?): 
  | {
...
Defined in: [packages/sdk/src/types.ts:835](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L835)
