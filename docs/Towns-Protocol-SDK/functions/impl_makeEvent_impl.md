# Function: \_impl\_makeEvent\_impl\_()

```ts
function _impl_makeEvent_impl_(
   context, 
   payload, 
   prevMiniblockHash?, 
   prevMiniblockNum?, 
...
Defined in: [packages/sdk/src/sign.ts:55](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sign.ts#L55)
