# Function: make\_MemberPayload\_Unpin()

```ts
function make_MemberPayload_Unpin(eventId): 
  | {
...
Defined in: [packages/sdk/src/types.ts:400](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L400)
