# Function: make\_ChannelPayload\_Inception()

```ts
function make_ChannelPayload_Inception(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:500](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L500)
...
from field: river.SpacePayload.ChannelSettings channel_settings = 7;

#### channelSettings.autojoin
...
#### channelSettings.hideUserJoinLeaveEvents
...
from field: river.StreamSettings settings = 5;
