# Function: make\_MemberPayload\_KeyFulfillment()

```ts
function make_MemberPayload_KeyFulfillment(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:851](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L851)
...
from field: string device_key = 2;
...
from field: bytes user_address = 1;
