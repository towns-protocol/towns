# Function: make\_SpacePayload\_SpaceImage()

```ts
function make_SpacePayload_SpaceImage(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:729](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L729)
