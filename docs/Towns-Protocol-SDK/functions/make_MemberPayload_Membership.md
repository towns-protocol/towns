# Function: make\_MemberPayload\_Membership()

```ts
function make_MemberPayload_Membership(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:247](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L247)
...
from field: bytes initiator_address = 3;
...
from field: river.MembershipOp op = 1;
...
from field: river.MembershipReason reason = 5;
...
from field: bytes user_address = 2;
