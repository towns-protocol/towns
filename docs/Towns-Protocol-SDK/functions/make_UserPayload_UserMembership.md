# Function: make\_UserPayload\_UserMembership()

```ts
function make_UserPayload_UserMembership(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:274](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L274)
...
from field: optional bytes inviter = 3;
...
from field: river.MembershipOp op = 2;
