# Function: make\_UserSettingsPayload\_Inception()

```ts
function make_UserSettingsPayload_Inception(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:575](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L575)
