# Function: make\_UserMetadataPayload\_Bio()

```ts
function make_UserMetadataPayload_Bio(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:701](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L701)
