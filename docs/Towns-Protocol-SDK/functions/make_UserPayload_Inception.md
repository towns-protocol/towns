# Function: make\_UserPayload\_Inception()

```ts
function make_UserPayload_Inception(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:261](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L261)
