# Function: make\_UserInboxPayload\_GroupEncryptionSessions()

```ts
function make_UserInboxPayload_GroupEncryptionSessions(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:645](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L645)
...
from field: map<string, string> ciphertexts = 4;
...
from field: string sender_key = 2;
...
from field: repeated string session_ids = 3;
