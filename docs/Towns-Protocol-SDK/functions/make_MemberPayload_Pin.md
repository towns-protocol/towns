# Function: make\_MemberPayload\_Pin()

```ts
function make_MemberPayload_Pin(eventHash, streamEvent): 
  | {
...
Defined in: [packages/sdk/src/types.ts:385](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L385)
