# Function: make\_UserSettingsPayload\_FullyReadMarkers()

```ts
function make_UserSettingsPayload_FullyReadMarkers(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:589](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L589)
...
from field: river.UserSettingsPayload.MarkerContent content = 2;
