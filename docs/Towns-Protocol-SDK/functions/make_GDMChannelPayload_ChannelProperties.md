# Function: make\_GDMChannelPayload\_ChannelProperties()

```ts
function make_GDMChannelPayload_ChannelProperties(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:561](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L561)
