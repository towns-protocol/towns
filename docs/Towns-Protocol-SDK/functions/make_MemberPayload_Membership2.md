# Function: make\_MemberPayload\_Membership2()

```ts
function make_MemberPayload_Membership2(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:535](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L535)

## Parameters

### value

`DeprecatedMembership`
