# Function: make\_MediaPayload\_Chunk()

```ts
function make_MediaPayload_Chunk(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:964](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L964)
...
from field: int32 chunk_index = 2;
...
from field: optional bytes iv = 3;
