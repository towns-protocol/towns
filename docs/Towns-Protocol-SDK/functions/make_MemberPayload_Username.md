# Function: make\_MemberPayload\_Username()

```ts
function make_MemberPayload_Username(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:343](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L343)
