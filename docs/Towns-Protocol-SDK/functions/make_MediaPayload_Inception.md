# Function: make\_MediaPayload\_Inception()

```ts
function make_MediaPayload_Inception(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:950](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L950)
...
from field: optional bytes channel_id = 2;
...
from field: int32 chunk_count = 3;
...
from field: optional bool per_chunk_encryption = 7;
...
from field: river.StreamSettings settings = 4;
...
from field: optional bytes space_id = 5;
...
from field: optional bytes user_id = 6;
