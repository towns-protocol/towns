# Function: make\_ChannelPayload\_Redaction()

```ts
function make_ChannelPayload_Redaction(eventId): 
  | {
...
Defined in: [packages/sdk/src/types.ts:819](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L819)
