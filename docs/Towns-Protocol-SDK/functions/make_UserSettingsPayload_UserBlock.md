# Function: make\_UserSettingsPayload\_UserBlock()

```ts
function make_UserSettingsPayload_UserBlock(value): 
  | {
...
Defined in: [packages/sdk/src/types.ts:603](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/types.ts#L603)
