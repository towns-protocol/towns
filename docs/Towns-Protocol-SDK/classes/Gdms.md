...
Defined in: [packages/sdk/src/sync-agent/gdms/gdms.ts:21](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/gdms/gdms.ts#L21)

## theme_extends

- [`PersistedObservable`](PersistedObservable.md)\<[`GdmsModel`](../interfaces/GdmsModel.md)\>
...
new Gdms(
   store, 
   riverConnection, 
   userMemberships): Gdms;
```

Defined in: [packages/sdk/src/sync-agent/gdms/gdms.ts:24](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/gdms/gdms.ts#L24)
...
```ts
protected subscribers: Subscription<PersistedModel<GdmsModel>>[] = [];
```
...
Defined in: [packages/sdk/src/sync-agent/gdms/gdms.ts:67](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/gdms/gdms.ts#L67)
...
Defined in: [packages/sdk/src/sync-agent/gdms/gdms.ts:41](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/gdms/gdms.ts#L41)
...
Defined in: [packages/sdk/src/sync-agent/gdms/gdms.ts:32](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/gdms/gdms.ts#L32)
...
[`PersistedModel`](../type-aliases/PersistedModel.md)\<[`GdmsModel`](../interfaces/GdmsModel.md)\>
...
```ts
when(condition, opts): Promise<PersistedModel<GdmsModel>>;
```
...
`Promise`\<[`PersistedModel`](../type-aliases/PersistedModel.md)\<[`GdmsModel`](../interfaces/GdmsModel.md)\>\>
