...
Defined in: [packages/sdk/src/sync-agent/spaces/spaces.ts:25](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/spaces/spaces.ts#L25)

## theme_extends

- [`PersistedObservable`](PersistedObservable.md)\<[`SpacesModel`](../interfaces/SpacesModel.md)\>
...
Defined in: [packages/sdk/src/sync-agent/spaces/spaces.ts:28](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/spaces/spaces.ts#L28)
...
```ts
protected subscribers: Subscription<PersistedModel<SpacesModel>>[] = [];
```
...
```ts
createSpace(params, signer): Promise<{
  defaultChannelId: string;
  spaceId: string;
}>;
```

Defined in: [packages/sdk/src/sync-agent/spaces/spaces.ts:82](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/spaces/spaces.ts#L82)

#### Parameters

##### params

`Partial`\<`Omit`\<[`CreateSpaceParams`](../../Towns-Protocol-Web3/interfaces/CreateSpaceParams.md), `"spaceName"`\>\> & `object`
...
Defined in: [packages/sdk/src/sync-agent/spaces/spaces.ts:46](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/spaces/spaces.ts#L46)
...
```ts
joinSpace(spaceId, ...args): Promise<void>;
```

Defined in: [packages/sdk/src/sync-agent/spaces/spaces.ts:119](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/spaces/spaces.ts#L119)
...
Defined in: [packages/sdk/src/sync-agent/spaces/spaces.ts:37](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/spaces/spaces.ts#L37)
...
[`PersistedModel`](../type-aliases/PersistedModel.md)\<[`SpacesModel`](../interfaces/SpacesModel.md)\>
...
```ts
when(condition, opts): Promise<PersistedModel<SpacesModel>>;
```
...
`Promise`\<[`PersistedModel`](../type-aliases/PersistedModel.md)\<[`SpacesModel`](../interfaces/SpacesModel.md)\>\>
