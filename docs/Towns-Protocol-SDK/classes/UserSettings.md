...
Defined in: [packages/sdk/src/sync-agent/user/models/userSettings.ts:19](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/user/models/userSettings.ts#L19)

## theme_extends

- [`PersistedObservable`](PersistedObservable.md)\<[`UserSettingsModel`](../interfaces/UserSettingsModel.md)\>
...
new UserSettings(
   id, 
   store, 
   riverConnection): UserSettings;
```

Defined in: [packages/sdk/src/sync-agent/user/models/userSettings.ts:20](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/user/models/userSettings.ts#L20)
...
```ts
protected subscribers: Subscription<PersistedModel<UserSettingsModel>>[] = [];
```
...
Defined in: [packages/sdk/src/sync-agent/user/models/userSettings.ts:32](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/user/models/userSettings.ts#L32)
...
[`PersistedModel`](../type-aliases/PersistedModel.md)\<[`UserSettingsModel`](../interfaces/UserSettingsModel.md)\>
...
```ts
when(condition, opts): Promise<PersistedModel<UserSettingsModel>>;
```
...
`Promise`\<[`PersistedModel`](../type-aliases/PersistedModel.md)\<[`UserSettingsModel`](../interfaces/UserSettingsModel.md)\>\>
