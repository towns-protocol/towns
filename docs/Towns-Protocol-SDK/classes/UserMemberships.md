...
Defined in: [packages/sdk/src/sync-agent/user/models/userMemberships.ts:28](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/user/models/userMemberships.ts#L28)

## theme_extends

- [`PersistedObservable`](PersistedObservable.md)\<[`UserMembershipsModel`](../interfaces/UserMembershipsModel.md)\>
...
new UserMemberships(
   id, 
   store, 
   riverConnection): UserMemberships;
```

Defined in: [packages/sdk/src/sync-agent/user/models/userMemberships.ts:31](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/user/models/userMemberships.ts#L31)
...
```ts
protected subscribers: Subscription<PersistedModel<UserMembershipsModel>>[] = [];
```
...
```ts
getMembership(streamId): undefined | UserMembership;
```

Defined in: [packages/sdk/src/sync-agent/user/models/userMemberships.ts:58](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/user/models/userMemberships.ts#L58)
...
`undefined` \| [`UserMembership`](../interfaces/UserMembership.md)
...
Defined in: [packages/sdk/src/sync-agent/user/models/userMemberships.ts:66](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/user/models/userMemberships.ts#L66)
...
Defined in: [packages/sdk/src/sync-agent/user/models/userMemberships.ts:62](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/user/models/userMemberships.ts#L62)
...
Defined in: [packages/sdk/src/sync-agent/user/models/userMemberships.ts:40](https://github.com/towns-protocol/towns/blob/0db1fd0ac7258e8db8cedfb6183e8eade8284fa1/packages/sdk/src/sync-agent/user/models/userMemberships.ts#L40)
...
[`PersistedModel`](../type-aliases/PersistedModel.md)\<[`UserMembershipsModel`](../interfaces/UserMembershipsModel.md)\>
...
```ts
when(condition, opts): Promise<PersistedModel<UserMembershipsModel>>;
```
...
`Promise`\<[`PersistedModel`](../type-aliases/PersistedModel.md)\<[`UserMembershipsModel`](../interfaces/UserMembershipsModel.md)\>\>
